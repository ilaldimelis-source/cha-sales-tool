...
var CACHE_NAME = 'cha-command-center-v395';
var URLS_TO_CACHE = [
  './',
  './index.html',
  './logo.png',
  ...
  './js/utils.js',
  './js/recovery-data.js',
  './js/objections.js?v=1779600200000',
  './js/plans-benefits.js?v=1779600000000',
  './js/call-playbook.js?v=1779600000000',
  './js/live-assist.js?v=1779600400000',
  './js/ai-tools.js?v=1779600400000',
  './js/training.js',
  './js/compliance.js',
  './js/plan-data.js',
  ...
  './js/policy-docs.js',
  './js/docusign-walkthrough.js?v=389',
  './js/myspace.js',
  './js/sales-tracker.js?v=1779400000000',
  './js/app.js?v=1779600400000',
