...
function renderComplianceFlags() {
  ...
  sections.forEach(function (sec) {
    ...
    sec.flags.forEach(function (rf) {
      html +=
        '<div style="background:#FFFFFF;border:1px solid #E8EBF5;border-radius:12px;padding:14px;margin-bottom:8px;"><div style="font-size:12px;font-weight:700;color:#1C2035;margin-bottom:6px;">🚩 ' +
        escHTML(rf.flag) +
