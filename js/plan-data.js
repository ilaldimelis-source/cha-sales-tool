...
var CHA_KNOWLEDGE_BASE_REF_TEXT =
  ...
  'MedFirst 1-3 / 4-5 First Health MBA VP Limited / TVP\n' +
  ...
  'MEC\n' +
  'Plan Name Network Underwriter Association\n' +
  'MedFirst 1-3 / 4-5 First Health MBA TVP\n' +
...
function chaApplyKnowledgeBasePdfToDocs(docs) {
  ...
  for (i = 0; i < docs.length; i++) {
    ...
    } else if (id === 'medfirst13' || id === 'medfirst45') {
      p.network = 'First Health';
      p.carrier = 'Merchants Benefit Administration (MBA)';
      p.assoc = 'VP Limited Partnership / The Vitamin Patch (TVP)';
    } else if (id === 'goodhealth13' || id === 'goodhealth45') {
      p.network = 'First Health';
      p.carrier = 'Merchants Benefit Administration (MBA)';
...
var POLICY_DOCS = [
  {
    ...
    planNotes:
      'Three tiers. Tiers 1-3 have no surgery, no ER, no ambulance coverage. Rx is discount-only on tier 1; tiers 2-3 include formulary coverage.',
    benefits: [
      {
        category: 'Doctor Visits',
        items: [
          'TrueHealth 1: PCP $25 copay -- 3 visits/yr -- $150 max/visit',
          'TrueHealth 1: Specialist or Urgent Care $50 copay -- 1 visit/yr -- $300 max/visit',
          'TrueHealth 2: PCP $25 copay -- 4 visits/yr -- $150 max/visit',
          'TrueHealth 2: Specialist or Urgent Care $50 copay -- 2 visits/yr -- $300 max/visit',
          'TrueHealth 3: PCP $25 copay -- 4 visits/yr -- $150 max/visit',
          'TrueHealth 3: Specialist or Urgent Care $50 copay -- 4 visits/yr -- $300 max/visit'
        ]
      },
      {
        category: 'Hospital',
        items: [
          'TrueHealth 1: Inpatient $1,000/day -- $5,000/yr max',
          'TrueHealth 2: Inpatient $1,000/day -- $10,000/yr max',
          'TrueHealth 3: Inpatient $1,000/day -- $15,000/yr max',
          'All tiers: 12/12 pre-existing condition exclusion applies',
          'Surgery: NOT covered on any TrueHealth tier',
          'Emergency Room: NOT covered on any TrueHealth tier',
          'Ambulance: NOT covered on any TrueHealth tier'
        ]
      },
      {
        category: 'Telemedicine',
        items: ['All tiers: $0 consult fee -- unlimited visits -- Opyn Live']
      },
      {
        category: 'Prescriptions',
        items: [
          'TrueHealth 1: Discount prescriptions only -- no formulary coverage',
          'TrueHealth 2/3: Formulary generic $0 copay',
          'TrueHealth 2/3: Preferred generic $5 copay',
          'TrueHealth 2/3: Brand (prior auth) $40 retail / $80 mail order',
          'TrueHealth 2/3: $150/month cap non-preventive Rx -- specialty NOT covered'
        ]
      },
      {
        category: 'Preventive / MEC',
        items: [
          'All tiers: Full ACA preventive services at $0 copay',
          'Annual physical 1/yr'
        ]
      },
      {
    ...
    limitations: [
      ...
      'No surgery coverage on any tier',
      'No ER coverage on any tier',
      'No ambulance coverage on any tier',
      'No maternity, mental health, or substance abuse coverage',
      'Rx is discount-only on Tier 1',
      'Benefits are fixed dollar amounts -- not full bill coverage',
    ...
    rawText:
      'TrueHealth 1 2 3 MEC Minimum Essential Coverage First Health Network Merchants Benefit Administration MBA VP Limited TVP three tiers PCP copay visits hospital inpatient no surgery no ER no ambulance telemedicine zero copay preventive ACA zero copay 30 day waiting period sickness 12 12 pre-existing'
  },
  {
    id: 'medfirst13',
    name: 'MedFirst 1-3',
    ...
    planNotes:
      'Entry-level MEC tiers 1-3. No surgery, no ER, no ambulance. Rx is discount-only.',
    benefits: [
      {
        category: 'Doctor Visits',
        items: [
          'MedFirst 1: PCP $25 copay -- 3 visits/yr -- $150 max/visit',
          'MedFirst 1: Specialist or Urgent Care $50 copay -- 1 visit/yr -- $300 max/visit',
          'MedFirst 2: PCP $25 copay -- 4 visits/yr -- $150 max/visit',
          'MedFirst 2: Specialist or Urgent Care $50 copay -- 2 visits/yr -- $300 max/visit',
          'MedFirst 3: PCP $25 copay -- 4 visits/yr -- $150 max/visit',
          'MedFirst 3: Specialist or Urgent Care $50 copay -- 4 visits/yr -- $300 max/visit',
          'All tiers: in-network providers only for outpatient physician visits'
        ]
      },
      {
        category: 'Hospital',
        items: [
          'MedFirst 1: Inpatient $1,000/day -- $5,000/yr max',
          'MedFirst 2: Inpatient $1,000/day -- $10,000/yr max',
          'MedFirst 3: Inpatient $1,000/day -- $15,000/yr max',
          'All tiers: 12/12 pre-existing condition exclusion applies',
          'Surgery: NOT covered on tiers 1-3',
          'Emergency Room: NOT covered on tiers 1-3',
          'Ambulance: NOT covered on tiers 1-3'
        ]
      },
      {
        category: 'Telemedicine',
        items: [
          'All tiers: $0 consult fee -- unlimited visits -- board-certified physicians 24/7'
        ]
      },
      {
        category: 'Prescriptions',
        items: ['All tiers 1-3: Discount prescriptions only -- no formulary coverage']
      },
      {
        category: 'Preventive / MEC',
        items: [
    ...
    limitations: [
      'NOT ACA-compliant major medical',
      'No surgery on tiers 1-3',
      'No ER on tiers 1-3',
      'No ambulance on tiers 1-3',
      'No maternity, mental health, or substance abuse coverage',
      'Rx discount-only -- no formulary',
      'Benefits are fixed dollar amounts',
      '30-day waiting period for sickness',
      '12/12 pre-existing condition exclusion'
    ],
    waitingPeriods: ['30 days -- sickness', 'Day 1 -- accidents'],
    preEx: '12-month exclusion for prior 12-month conditions',
    rawText:
      'MedFirst 1 2 3 MEC First Health Merchants Benefit Administration MBA VP Limited TVP entry level tiers PCP copay visits hospital inpatient no surgery no ER no ambulance telemedicine zero copay preventive ACA 30 day waiting period 12 12 pre-existing discount Rx only'
  },
  {
    id: 'medfirst45',
    name: 'MedFirst 4-5',
    ...
    planNotes:
      'Upper MEC tiers 4-5. Surgery, ER (if admitted), and ambulance ARE covered. Full formulary Rx included.',
    benefits: [
      {
        category: 'Doctor Visits',
        items: [
          'MedFirst 4: Wellness Exam $25 copay -- 1 visit/yr -- $150 max',
          'MedFirst 4: PCP $50 copay -- 4 visits/yr -- $150 max',
          'MedFirst 4: Specialist or Urgent Care $75 copay -- 4 visits/yr -- $300 max',
          'MedFirst 5: Wellness Exam $25 copay -- 1 visit/yr -- $150 max',
          'MedFirst 5: PCP $50 copay -- 5 visits/yr -- $150 max',
          'MedFirst 5: Specialist or Urgent Care $75 copay -- 5 visits/yr -- $300 max'
        ]
      },
      {
        category: 'Hospital & Surgery',
        items: [
          'MedFirst 4: Inpatient $1,000/day -- $10,000/yr max -- 12/12 pre-ex',
          'MedFirst 4: Surgery $1,000/yr -- $2,000/yr max -- 12/12 pre-ex',
          'MedFirst 4: ER (if admitted) $1,000/incident -- 12/12 pre-ex',
          'MedFirst 4: Ambulance (if admitted) $500/incident -- 12/12 pre-ex',
          'MedFirst 5: Inpatient $1,500/day -- $15,000/yr max -- 12/12 pre-ex',
          'MedFirst 5: Surgery $1,500/yr -- $4,500/yr max -- 12/12 pre-ex',
          'MedFirst 5: ER (if admitted) $1,000/incident -- 12/12 pre-ex',
          'MedFirst 5: Ambulance (if admitted) $500/incident -- 12/12 pre-ex'
        ]
      },
      {
        category: 'Telemedicine',
        items: ['All tiers: $0 consult fee -- unlimited visits']
      },
      {
        category: 'Prescriptions',
        items: [
    ...
    limitations: [
      'NOT ACA-compliant major medical',
      'ER covered ONLY if admitted to hospital',
      'Ambulance covered ONLY if admitted to hospital',
      'No maternity, mental health, or substance abuse coverage',
    ...
    preEx: '12-month exclusion for prior 12-month conditions',
    rawText:
      'MedFirst 4 5 MEC First Health Merchants Benefit Administration MBA VP Limited TVP upper tiers surgery ER if admitted ambulance if admitted formulary Rx generic copay 30 day waiting period 12 12 pre-existing'
  },
  {
    id: 'goodhealth13',
    name: 'GoodHealth 1-3',
    ...
    benefits: [
      {
        category: 'Doctor Visits',
        items: [
          'GoodHealth 1: PCP $25 copay -- 3 visits/yr -- $150 max',
          'GoodHealth 1: Specialist or Urgent Care $50 copay -- 1 visit/yr -- $300 max',
          'GoodHealth 2: PCP $25 copay -- 4 visits/yr -- $150 max',
          'GoodHealth 2: Specialist or Urgent Care $50 copay -- 2 visits/yr -- $300 max',
          'GoodHealth 3: PCP $25 copay -- 4 visits/yr -- $150 max',
          'GoodHealth 3: Specialist or Urgent Care $50 copay -- 4 visits/yr -- $300 max'
        ]
      },
      {
        category: 'Hospital',
        items: [
          'GoodHealth 1: Inpatient $1,000/day -- $5,000/yr max -- 12/12 pre-ex',
          'GoodHealth 2: Inpatient $1,000/day -- $10,000/yr max -- 12/12 pre-ex',
          'GoodHealth 3: Inpatient $1,000/day -- $15,000/yr max -- 12/12 pre-ex',
          'Surgery: NOT covered on tiers 1-3',
          'Emergency Room: NOT covered on tiers 1-3',
          'Ambulance: NOT covered on tiers 1-3'
        ]
      ...
      {
        category: 'Preventive / MEC',
        items: ['All tiers: Full ACA preventive services at $0 copay']
      },
      {
        category: 'Plan Structure',
        items: [
    ...
    preEx: '12-month exclusion for prior 12-month conditions',
    rawText:
      'GoodHealth 1 2 3 MEC First Health Merchants Benefit Administration MBA Good Health Distribution Partners entry tiers PCP copay visits hospital inpatient no surgery no ER no ambulance telemedicine zero copay Kindly Human peer support preventive ACA 30 day waiting period 12 12 pre-existing'
  },
  {
    id: 'goodhealth45',
    name: 'GoodHealth 4-5',
    ...
    benefits: [
      {
        category: 'Doctor Visits',
        items: [
          'GoodHealth 4: Wellness Exam $25 copay -- 1 visit/yr -- $150 max',
          'GoodHealth 4: PCP $50 copay -- 4 visits/yr -- $150 max',
          'GoodHealth 4: Specialist or Urgent Care $75 copay -- 4 visits/yr -- $300 max',
          'GoodHealth 5: Wellness Exam $25 copay -- 1 visit/yr -- $150 max',
          'GoodHealth 5: PCP $50 copay -- 5 visits/yr -- $150 max',
          'GoodHealth 5: Specialist or Urgent Care $75 copay -- 5 visits/yr -- $300 max'
        ]
      },
      {
        category: 'Hospital & Surgery',
        items: [
          'GoodHealth 4: Inpatient $1,000/day -- $10,000/yr max -- 12/12 pre-ex',
          'GoodHealth 4: Surgery $1,000/yr -- $2,000/yr max -- 12/12 pre-ex',
          'GoodHealth 4: ER (if admitted) $1,000/incident -- 12/12 pre-ex',
          'GoodHealth 4: Ambulance (if admitted) $500/incident -- 12/12 pre-ex',
          'GoodHealth 5: Inpatient $1,500/day -- $15,000/yr max -- 12/12 pre-ex',
          'GoodHealth 5: Surgery $1,500/yr -- $4,500/yr max -- 12/12 pre-ex',
          'GoodHealth 5: ER (if admitted) $1,000/incident -- 12/12 pre-ex',
          'GoodHealth 5: Ambulance (if admitted) $500/incident -- 12/12 pre-ex'
        ]
      },
      {
        category: 'Telemedicine',
    ...
    limitations: [
      ...
      'No maternity, mental health, or substance abuse coverage',
      '$150/month Rx cap non-preventive',
      'Specialty drugs NOT covered',
      'Benefits are fixed dollar amounts',
      '30-day waiting period for sickness',
      '12/12 pre-existing condition exclusion'
    ...
    preEx: '12-month exclusion for prior 12-month conditions',
    rawText:
      'GoodHealth 4 5 MEC First Health Merchants Benefit Administration MBA Good Health Distribution Partners upper tiers surgery ER if admitted ambulance formulary Rx generic copay 30 day waiting period 12 12 pre-existing'
  },
  {
    id: 'tdk13',
    name: 'TDK 1-3',
    ...
    planNotes:
      'TDK tiers 1-3. No surgery, no ER, no ambulance. Rx via MyLiveDoc only. Member becomes Working Owner of HCDA. Billed through FirstEnroll or NEO Insurance Solutions.',
    benefits: [
      {
        category: 'Doctor Visits',
        items: [
          'TDK 1: PCP $25 copay -- 3 visits/yr -- $150 max/visit',
          'TDK 1: Specialist $50 copay -- 1 visit/yr -- $300 max/visit',
          'TDK 1: Urgent Care $50 copay -- 1 visit/yr -- $300 max/visit',
          'TDK 2: PCP $25 copay -- 4 visits/yr -- $150 max/visit',
          'TDK 2: Specialist $50 copay -- 2 visits/yr -- $300 max/visit',
          'TDK 2: Urgent Care $50 copay -- 2 visits/yr -- $300 max/visit',
          'TDK 3: PCP $25 copay -- 4 visits/yr -- $150 max/visit',
          'TDK 3: Specialist $50 copay -- 4 visits/yr -- $300 max/visit',
          'TDK 3: Urgent Care $50 copay -- 4 visits/yr -- $300 max/visit'
        ]
      },
      {
        category: 'Hospital',
        items: [
          'TDK 1: Inpatient $1,000/day -- $5,000/yr max',
          'TDK 2: Inpatient $1,000/day -- $10,000/yr max',
          'TDK 3: Inpatient $1,000/day -- $15,000/yr max',
          'Surgery: NOT covered on TDK 1-3',
          'Emergency Room: NOT covered on TDK 1-3',
          'Ambulance: NOT covered on TDK 1-3'
        ]
      },
      {
        category: 'Telemedicine (MyLiveDoc)',
        items: [
          'All tiers: Virtual Primary Care $0 copay',
          'All tiers: Virtual Urgent Care $0 copay',
          'All tiers: Virtual Mental Health 4 visits/yr per family member'
        ]
      },
      {
        category: 'Prescriptions',
        items: [
          'All tiers: Rx available via MyLiveDoc only',
          'Brand/specialty drugs: NOT covered'
        ]
      },
      {
        category: 'Preventive / MEC',
        items: ['All tiers: ACA preventive $0 copay -- 1 visit/yr -- $150 max/visit']
      },
      {
        category: 'Plan Structure',
        items: [
          'No deductible -- fixed dollar benefit plan',
          'No out-of-pocket maximum',
          'Member becomes Working Owner of HCDA',
          'This is a group plan -- not individual insurance',
          'Accidents covered from Day 1',
          '30-day waiting period for sickness'
        ]
      }
    ...
    limitations: [
      'NOT ACA-compliant major medical',
      'No surgery on TDK 1-3',
      'No ER on TDK 1-3',
      'No ambulance on TDK 1-3',
      'No mental health inpatient coverage',
      'Rx via MyLiveDoc only -- brand/specialty NOT covered',
      'Benefits are fixed dollar amounts',
      '30-day waiting period for sickness',
      '12/12 pre-existing condition exclusion',
      'No out-of-pocket maximum'
    ...
    preEx: '12-month exclusion for prior 12-month conditions',
    rawText:
      'TDK 1 2 3 MEC First Health Detego Health HCDA Health Care Data Analytics group plan working owner no surgery no ER no ambulance telemedicine MyLiveDoc zero copay preventive ACA 30 day waiting period 12 12 pre-existing FirstEnroll NEO Insurance Solutions'
  },
  {
    id: 'tdk45',
    name: 'TDK 4-5',
    ...
    source: 'TDK_Promo_Combined.pdf',
    planNotes:
      'TDK tiers 4-5. Surgery, ER, and ambulance ARE covered. Member becomes Working Owner of HCDA. Billed through FirstEnroll or NEO Insurance Solutions.',
    benefits: [
      {
        category: 'Doctor Visits',
        items: [
          'TDK 4: PCP $50 copay -- 4 visits/yr -- $150 max/visit',
          'TDK 4: Specialist $75 copay -- 4 visits/yr -- $300 max/visit',
          'TDK 4: Urgent Care $75 copay -- 4 visits/yr -- $300 max/visit',
          'TDK 5: PCP $50 copay -- 5 visits/yr -- $150 max/visit',
          'TDK 5: Specialist $75 copay -- 5 visits/yr -- $300 max/visit',
          'TDK 5: Urgent Care $75 copay -- 5 visits/yr -- $300 max/visit'
        ]
      },
      {
        category: 'Hospital & Surgery',
        items: [
          'TDK 4: Inpatient $1,000/day -- $10,000/yr max',
          'TDK 4: Outpatient Surgery $1,000/day -- $10,000/yr max',
          'TDK 4: ER Facility $1,000/day -- $2,000/yr max',
          'TDK 4: ER Professional $1,000/incident',
          'TDK 4: Ambulance $500/incident (if admitted)',
          'TDK 5: Inpatient $1,500/day -- $15,000/yr max',
          'TDK 5: Outpatient Surgery $1,500/incident',
          'TDK 5: ER $1,500/day -- $4,500/yr max',
          'TDK 5: Ambulance $500 (if admitted)'
        ]
      },
      {
        category: 'Telemedicine (MyLiveDoc)',
    ...
    limitations: [
      'NOT ACA-compliant major medical',
      'ER benefit pays ONLY if member is admitted to hospital',
      'Ambulance covered ONLY if admitted',
      'No mental health inpatient coverage',
      'Rx via MyLiveDoc only -- brand/specialty NOT covered',
      'Benefits are fixed dollar amounts',
    ...
    preEx: '12-month exclusion for prior 12-month conditions',
    rawText:
      'TDK 4 5 MEC First Health Detego Health HCDA Health Care Data Analytics group plan working owner surgery ER ambulance covered telemedicine MyLiveDoc zero copay preventive ACA 30 day waiting period 12 12 pre-existing FirstEnroll NEO Insurance Solutions'
  },
{
    id: 'smartchoice',
    name: 'SmartChoice',
