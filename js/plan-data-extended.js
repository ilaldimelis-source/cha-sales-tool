...
(function () {
  var EXTENDED_PLANS = [
    ...
    // SMART CHOICE 1500
    {
      ...
      benefits: [
        { category: 'Deductible', detail: 'Individual $1,500 / Family $3,000 (Embedded)' },
        { category: 'Out-of-Pocket Max', detail: 'Individual $9,200 / Family $18,400' },
        { category: 'Primary Care Visit', detail: '$40 copay — 12 visit limit per year' },
        { category: 'Specialist Visit', detail: '$50 copay — 12 visit limit per year' },
        { category: 'Urgent Care', detail: '$250 copay after deductible — 5 visit limit' },
        { category: 'Emergency Room', detail: '$1,500 max payment after deductible — 4 per family per benefit period' },
        { category: 'Inpatient Hospital', detail: '$2,500 copay after deductible — 1 per family, up to 7 days' },
        { category: 'Outpatient Hospital', detail: '$60 copay after deductible — 4 per family (elective surgeries excluded)' },
        { category: 'Telehealth', detail: '$0 copay — Primary Care, Mental Health, Urgent Care' },
        { category: 'Ambulance', detail: 'Ground: $750 copay after deductible. Air: $2,500 copay after deductible' },
        { category: 'Advanced Imaging', detail: '$250 copay after deductible — 4 per benefit period' },
        { category: 'Radiology/X-ray', detail: '$75 copay after deductible — 4 per family per benefit period' },
        { category: 'Mental Health Inpatient', detail: '$250 copay after deductible — 10 day limit' },
        { category: 'Mental Health Outpatient', detail: '$50 copay after deductible — 10 visit limit' },
        { category: 'Preventive Care', detail: 'ACA required services — Plan pays 100%' },
        { category: 'Prescriptions', detail: 'Generic $12 copay retail 30-day. Specialty via ScriptAide patient assistance' },
        { category: 'Rehabilitation', detail: '$50 copay after deductible — 10 visit combined limit' },
        { category: 'Home Health / Hospice / Skilled Nursing', detail: '$50 copay after deductible — 10 visit limit each' },
        { category: 'DME', detail: '$50 copay after deductible — 10 visit limit (precertification required if $500+)' },
        { category: 'Maternity', detail: 'Not covered (except ACA preventive services)' },
        { category: 'Infertility', detail: 'Not covered' },
        { category: 'Out-of-Network', detail: 'Not covered (emergency at in-network level)' }
      ],
      limitations: [
    ...
    // SMART CHOICE 3000
    {
      ...
      network: 'First Health Network',
      benefits: [
        { category: 'Deductible', detail: 'Individual $3,000 / Family $6,000 (Embedded)' },
        { category: 'Out-of-Pocket Max', detail: 'Individual $9,200 / Family $18,400' },
        { category: 'Primary Care Visit', detail: '$40 copay — 7 visit limit per year' },
        { category: 'Specialist Visit', detail: '$50 copay — 7 visit limit per year' },
        { category: 'Urgent Care', detail: '$250 copay after deductible — 3 visit limit' },
        { category: 'Emergency Room', detail: '$1,500 max payment after deductible — 2 per family per benefit period' },
        { category: 'Inpatient Hospital', detail: '$2,500 copay after deductible — 1 per family, up to 4 days' },
        { category: 'Outpatient Hospital', detail: '$60 copay after deductible — 2 per family (elective surgeries excluded)' },
        { category: 'Telehealth', detail: '$0 copay — Primary Care, Mental Health, Urgent Care' },
        { category: 'Ambulance', detail: 'Ground: $750 copay after deductible. Air: $2,500 copay after deductible' },
        { category: 'Advanced Imaging', detail: '$250 copay after deductible — 2 per benefit period' },
        { category: 'Radiology/X-ray', detail: '$75 copay after deductible — 2 per family per benefit period' },
        { category: 'Mental Health Inpatient', detail: '$250 copay after deductible — 5 day limit' },
        { category: 'Mental Health Outpatient', detail: '$50 copay after deductible — 5 visit limit' },
        { category: 'Preventive Care', detail: 'ACA required services — Plan pays 100%' },
        { category: 'Prescriptions', detail: 'Generic $12 copay retail 30-day via Ventegra formulary' },
        { category: 'Rehabilitation', detail: '$50 copay after deductible — 5 visit combined limit' },
        { category: 'Home Health / Hospice / Skilled Nursing', detail: '$50 copay after deductible — 5 visit limit each' },
        { category: 'DME', detail: '$50 copay after deductible — 5 visit combined limit' },
        { category: 'Maternity', detail: 'Not covered' },
        { category: 'Out-of-Network', detail: 'Not covered (emergency at in-network level)' }
      ],
      limitations: [
    ...
    // SMART CHOICE 3500
    {
      ...
      network: 'First Health Network',
      benefits: [
        { category: 'Deductible', detail: 'Individual $3,500 / Family $7,000 (Embedded)' },
        { category: 'Out-of-Pocket Max', detail: 'Individual $9,200 / Family $18,400' },
        { category: 'Primary Care Visit', detail: '$40 copay — 5 visit limit per year' },
        { category: 'Specialist Visit', detail: '$50 copay — 5 visit limit per year' },
        { category: 'Urgent Care', detail: '$250 copay after deductible — 2 visit limit' },
        { category: 'Emergency Room', detail: '$1,500 max payment after deductible — 1 per family per benefit period' },
        { category: 'Inpatient Hospital', detail: '$2,500 copay after deductible — 1 per family, up to 3 days' },
        { category: 'Outpatient Hospital', detail: '$60 copay after deductible — 1 per family (elective surgeries excluded)' },
        { category: 'Telehealth', detail: '$0 copay — Primary Care, Mental Health, Urgent Care' },
        { category: 'Advanced Imaging', detail: '$250 copay after deductible — 1 per benefit period' },
        { category: 'Radiology/X-ray', detail: '$75 copay after deductible — 1 per family per benefit period' },
        { category: 'Mental Health Inpatient', detail: '$250 copay after deductible — 3 day limit' },
        { category: 'Mental Health Outpatient', detail: '$50 copay after deductible — 3 visit limit' },
        { category: 'Preventive Care', detail: 'ACA required services — Plan pays 100%' },
        { category: 'Prescriptions', detail: 'Generic $12 copay retail 30-day via Ventegra formulary' },
        { category: 'Rehabilitation', detail: '$50 copay after deductible — 3 visit combined limit' },
        { category: 'Home Health / Hospice / Skilled Nursing', detail: '$50 copay after deductible — 3 visit limit each' },
        { category: 'DME', detail: '$50 copay after deductible — 3 visit combined limit' },
        { category: 'Maternity', detail: 'Not covered' },
        { category: 'Out-of-Network', detail: 'Not covered' }
      ],
      limitations: [
    ...
    // PINNACLE PROTECT PLAN 1
    {
      ...
      benefits: [
        { category: 'Plan Type', detail: 'Limited Medical — fixed cash benefit per covered service' },
        { category: 'Underwriting', detail: 'Guaranteed Issue' },
        { category: 'Pre-Existing Condition', detail: '12-month look-back / 12-month exclusion period (12/12)' },
        { category: 'Hospital Confinement', detail: '$400/day — 10 days per confinement, 30 days per certificate year' },
        { category: 'ICU Confinement', detail: '$400/day — 10 days per confinement, 30 days per certificate year' },
        { category: 'Hospital Admission', detail: '$400 — 2 per certificate year' },
        { category: 'In-Hospital Physician Visit', detail: '$50 — 3 days per certificate year' },
        { category: 'Surgery Inpatient', detail: '$500 — 1 maximum day per certificate year' },
        { category: 'Surgery Outpatient', detail: '$500 — 1 maximum day (shared with inpatient max)' },
        { category: 'Anesthesia', detail: '25% of surgery benefit' },
        { category: 'Outpatient Surgery Center', detail: '$500 — 1 day per certificate year' },
        { category: 'Blood Products', detail: '$35 — 3 days per certificate year' },
        { category: 'Lab', detail: '$30 — 2 per certificate year' },
        { category: 'X-Rays', detail: '$25 — 2 per certificate year' },
        { category: 'Advanced Diagnostic', detail: '$250 — 1 per certificate year' },
        { category: "Physician's Office", detail: '$50 — 2 per certificate year' },
        { category: 'Urgent Care', detail: '$50 — 1 per certificate year' },
        { category: 'Emergency Room', detail: '$100 — 1 per certificate year' },
        { category: 'Wellness', detail: '$75 — 1 per certificate year' }
      ],
      limitations: [
    ...
    // PINNACLE PROTECT PLAN 2
    {
      ...
      network: 'Multiplan PHCS Practitioner & Ancillary Network',
      benefits: [
        { category: 'Plan Type', detail: 'Limited Medical — fixed cash benefit, higher tier than Plan 1' },
        { category: 'Underwriting', detail: 'Guaranteed Issue' },
        { category: 'Pre-Existing Condition', detail: '12-month look-back / 12-month exclusion period' },
        { category: 'Network', detail: 'Multiplan PHCS Practitioner & Ancillary Network' }
      ],
      limitations: [
        'Limited benefit plan — NOT comprehensive health insurance',
        'NOT a substitute for major medical coverage',
    ...
    // PINNACLE PROTECT PLAN 3
    {
      ...
      network: 'Multiplan PHCS Practitioner & Ancillary Network',
      benefits: [
        { category: 'Plan Type', detail: 'Limited Medical — fixed cash benefit, higher tier than Plan 2' },
        { category: 'Underwriting', detail: 'Guaranteed Issue' },
        { category: 'Pre-Existing Condition', detail: '12-month look-back / 12-month exclusion period' },
        { category: 'Network', detail: 'Multiplan PHCS Practitioner & Ancillary Network' }
      ],
    ...
    // PINNACLE PROTECT PLAN 4
    {
      ...
      network: 'Multiplan PHCS Practitioner & Ancillary Network',
      benefits: [
        { category: 'Plan Type', detail: 'Limited Medical — fixed cash benefit, highest Pinnacle Protect tier' },
        { category: 'Underwriting', detail: 'Guaranteed Issue' },
        { category: 'Pre-Existing Condition', detail: '12-month look-back / 12-month exclusion period' },
        { category: 'Network', detail: 'Multiplan PHCS Practitioner & Ancillary Network' }
      ],
    ...
    // PINNACLE CRITICAL CARE PLAN 1
    {
      ...
      benefits: [
        { category: 'Plan Type', detail: 'Critical Care supplement — designed as add-on to STM or other coverage' },
        { category: 'Coverage Focus', detail: 'Critical illness and hospital-level events' },
        { category: 'Network', detail: 'Pinnacle / NEO network' }
      ],
      limitations: [
    ...
    // PINNACLE CRITICAL CARE PLAN 2
    {
      ...
      network: 'NEO / Pinnacle Network',
      benefits: [
        { category: 'Plan Type', detail: 'Critical Care supplement — higher tier than Plan 1' },
        { category: 'Network', detail: 'Pinnacle / NEO network' }
      ],
    ...
    // PINNACLE CRITICAL CARE PLAN 3
    {
      ...
      network: 'NEO / Pinnacle Network',
      benefits: [
        { category: 'Plan Type', detail: 'Critical Care supplement — higher tier than Plan 2' },
        { category: 'Network', detail: 'Pinnacle / NEO network' }
      ],
      limitations: ['Supplemental plan', 'Limited benefit', 'Does not satisfy ACA MEC'],
      waitingPeriods: ['Check certificate for waiting periods'],
    ...
    // PINNACLE CRITICAL CARE PLAN 4
    {
      ...
      network: 'NEO / Pinnacle Network',
      benefits: [
        { category: 'Plan Type', detail: 'Critical Care supplement — highest Pinnacle Critical Care tier' },
        { category: 'Network', detail: 'Pinnacle / NEO network' }
      ],
      limitations: ['Supplemental plan', 'Limited benefit', 'Does not satisfy ACA MEC'],
      waitingPeriods: ['Check certificate for waiting periods'],
    ...
    // ALLSTATE ENHANCED STM PPO
    {
      ...
      network: 'PPO Network',
      benefits: [
        { category: 'Plan Type', detail: 'Short Term Medical — PPO network' },
        { category: 'Deductible Options', detail: '$2,500 / $5,000 / $7,500 / $10,000 / $25,000' },
        { category: 'Coinsurance Options', detail: '0% / 20% / 50% depending on deductible tier' },
        { category: 'Coverage Period Maximum', detail: '$1,000,000' },
        { category: 'Office Visits', detail: 'Subject to deductible and coinsurance including preventive' },
        { category: 'Outpatient Services', detail: 'Subject to deductible and coinsurance — $5,000 limit on joint/spine/connective tissue; 30-visit PT/OT/ST/Cardiac/Pulmonary rehab limit' },
        { category: 'Inpatient Hospital', detail: 'Subject to deductible and coinsurance' },
        { category: 'Emergency Room', detail: '$250 access fee + deductible and coinsurance (waived if admitted)' },
        { category: 'Urgent Care', detail: '$50 access fee — deductible waived, remaining subject to coinsurance' },
        { category: 'Diagnostic/Lab/X-ray', detail: 'Subject to deductible and coinsurance' },
        { category: 'Child Immunizations', detail: 'First dollar benefit (no deductible)' },
        { category: 'Out-of-Network', detail: 'Deductibles and coinsurance doubled; coinsurance % same' }
      ],
      limitations: [
    ...
    // ALLSTATE COPAY ENHANCED STM PPO
    {
      ...
      network: 'PPO Network',
      benefits: [
        { category: 'Plan Type', detail: 'Short Term Medical — PPO with copay structure' },
        { category: 'Deductible Options', detail: '$6,000 or $8,000' },
        { category: 'Coinsurance', detail: '0% (no coinsurance after deductible)' },
        { category: 'Coverage Period Maximum', detail: '$5,000,000' },
        { category: 'Office Visits (Copay)', detail: '$40 PCP / $60 Specialist including preventive' },
        { category: 'Pharmacy', detail: '$10 copay on generic drugs — maximum benefit $3,000' },
        { category: 'Outpatient Services', detail: 'Subject to deductible — $5,000 limit on joint/spine/connective tissue; 30-visit PT/OT/ST rehab limit' },
        { category: 'Inpatient Hospital', detail: 'Subject to deductible' },
        { category: 'Emergency Room', detail: '$250 access fee + deductible (waived if admitted)' },
        { category: 'Urgent Care', detail: '$50 access fee — deductible waived, remaining subject to coinsurance' },
        { category: 'Child Immunizations', detail: 'First dollar benefit' },
        { category: 'Out-of-Network', detail: 'Deductibles doubled; copays not applicable out-of-network' }
      ],
      limitations: [
    ...
    // ALLSTATE ESSENTIALS STM PPO
    {
      ...
      network: 'PPO Network',
      benefits: [
        { category: 'Plan Type', detail: 'Short Term Medical — entry-level STM PPO' },
        { category: 'Deductible Options', detail: '$5,000 / $10,000 / $25,000' },
        { category: 'Coinsurance', detail: '40% (member pays 40% after deductible)' },
        { category: 'Coinsurance OOP Max', detail: '$7,500 per member' },
        { category: 'Coverage Period Maximum', detail: '$250,000' },
        { category: 'Office Visits', detail: 'Subject to deductible and coinsurance including preventive' },
        { category: 'Outpatient Services', detail: 'Subject to deductible and coinsurance — $15,000 limit; $5,000 joint/spine limit; 30-visit PT/OT/ST rehab limit' },
        { category: 'Inpatient Hospital', detail: 'Subject to deductible and coinsurance' },
        { category: 'Emergency Room', detail: '$250 access fee + deductible and coinsurance (waived if admitted)' },
        { category: 'Urgent Care', detail: '$50 access fee — deductible waived, remaining subject to coinsurance' },
        { category: 'Child Immunizations', detail: 'First dollar benefit' },
        { category: 'Out-of-Network', detail: 'Deductibles doubled; coinsurance same' }
      ],
      limitations: [
    ...
    // ALLSTATE HEALTH ACCESS
    {
      ...
      benefits: [
        { category: 'Eligibility Note', detail: 'Males over 300 lbs and females over 250 lbs NOT eligible' },
        { category: 'Deductible', detail: '$0' },
        { category: 'Waiting Period', detail: '3 months for preventive services only' },
        { category: 'Hospital Admission (PLUS tier)', detail: 'Year 1: $6,000 / Year 2: $9,000 / Year 3: $12,000' },
        { category: 'Hospital Confinement Sickness (PLUS)', detail: '$6,000 — unlimited days' },
        { category: 'Hospital Confinement Injury (PLUS)', detail: '$6,000 — unlimited days' },
        { category: 'ICU Confinement (PLUS)', detail: '$6,000 — 60 days' },
        { category: 'Emergency Room (PLUS)', detail: '$300' },
        { category: 'Surgery Tier 1 (PLUS)', detail: '$10,000 — 3 days' },
        { category: 'Surgery Tier 2 (PLUS)', detail: '$5,000 — 4 days' },
        { category: 'Outpatient Surgery (PLUS)', detail: '$5,000 — 4 days' },
        { category: 'Anesthesia Tier 1 (PLUS)', detail: '$5,000' },
        { category: 'Ambulatory Surgical Center (PLUS)', detail: '$3,000 — 3 days' },
        { category: 'Office Visit (PLUS)', detail: '$200 — 4 covered visits' },
        { category: 'Urgent Care (PLUS)', detail: '$150 — 4 visits' },
        { category: 'Inpatient Physician (PLUS)', detail: '$200 — 4 visits' },
        { category: 'Laboratory Tests (PLUS)', detail: '$35 — 10 visits' },
        { category: 'Chemotherapy (PLUS)', detail: '$4,000 monthly max' },
        { category: 'Observation Unit (PLUS)', detail: '$1,500 — 3 days' },
        { category: 'Ambulance Ground (PLUS)', detail: '$25,000' },
        { category: 'Ambulance Air (PLUS)', detail: '$1,500 — 2 days' }
      ],
      limitations: [
    ...
    // MYCHOICE PLAN LOW
    {
      ...
      benefits: [
        { category: 'Plan Type', detail: 'Limited benefit — MyChoice entry-level plan' },
        { category: 'Tier', detail: 'Low tier — lowest benefit levels of MyChoice series' }
      ],
      limitations: [
        'Limited benefit plan — not comprehensive health insurance',
    ...
    // MYCHOICE PLAN MID
    {
      ...
      network: 'See plan certificate for network details',
      benefits: [
        { category: 'Plan Type', detail: 'Limited benefit — MyChoice mid-tier plan' },
        { category: 'Tier', detail: 'Mid tier — moderate benefit levels of MyChoice series' }
      ],
      limitations: [
        'Limited benefit plan — not comprehensive health insurance',
        'Not a substitute for major medical',
    ...
    // MYCHOICE PLAN HIGH
    {
      ...
      network: 'See plan certificate for network details',
      benefits: [
        { category: 'Plan Type', detail: 'Limited benefit — MyChoice highest-tier plan' },
        { category: 'Tier', detail: 'High tier — highest benefit levels of MyChoice series' }
      ],
      limitations: [
        'Limited benefit plan — not comprehensive health insurance',
        'Not a substitute for major medical',
    ...
    // TRUE HEALTH 2
    {
      ...
      network: 'First Health Network',
      benefits: [
        { category: 'Primary Care Visit', detail: '$25 copay / $150 max per visit — 4 visits per year' },
        { category: 'Specialist / Urgent Care', detail: '$50 copay / $300 max per visit — 2 visits per year' },
        { category: 'Inpatient Hospitalization', detail: '$1,000 per day — $10,000 per year maximum — 12/12 pre-ex applies' },
        { category: 'Telemedicine', detail: '$0 consult fee — unlimited' },
        { category: 'Prescriptions Generic', detail: '$0 copay — generic acute/preventive drugs on formulary' },
        { category: 'Prescriptions Maintenance', detail: 'Preferred Generic $5 copay — 200 generic maintenance drugs' },
        { category: 'Prescription Terms', detail: 'Specialty drugs not covered — Prescription Assistance Program available income-based. Mail order optional.' },
        { category: 'Hospital Bill Reducer', detail: 'Advocacy service included' }
      ],
      limitations: [
    ...
    // TRUE HEALTH 3
    {
      ...
      benefits: [
        { category: 'Primary Care Visit', detail: '$25 copay / $150 max per visit — 4 visits per year' },
        { category: 'Specialist / Urgent Care', detail: '$50 copay / $300 max per visit — 4 visits per year' },
        { category: 'Inpatient Hospitalization', detail: '$1,000 per day — $15,000 per year maximum — 12/12 pre-ex applies' },
        { category: 'Telemedicine', detail: '$0 consult fee — unlimited' },
        { category: 'Prescriptions Generic', detail: '$0 copay — generic acute/preventive drugs on formulary' },
        { category: 'Prescriptions Maintenance', detail: 'Preferred Generic $5 copay — 200 generic maintenance drugs' },
        { category: 'Prescriptions Non-preferred Generic', detail: 'Retail 30-day $5/$10 copay. Mail order 90-day $5/$20 copay' },
        { category: 'Prescriptions Brand', detail: 'Prior Authorization required — Retail 30-day $40. Mail order 90-day $80' },
        { category: 'Prescription Terms', detail: '$150 benefit limit per person per month for non-preventive maintenance Rx. Specialty drugs not covered.' },
        { category: 'Hospital Bill Reducer', detail: 'Advocacy service included' }
      ],
      limitations: [
        'MEC plan — covers preventive and limited physician services only',
