...
function renderScripts() {
  ...
  var html =
    '<div class="ph"><div class="pt">Script <span>Trainer</span></div><div class="pd">Learn to sound natural, not robotic. Multiple tones for every moment.</div></div>';
  html += '<div class="stabs">';
  tabs.forEach(function (t, i) {
    html +=
      '<button class="stab' +
      (t === isaScriptTab ? ' active' : '') +
      '" onclick="setIsaScriptTab(\'' +
      t +
      '\')">' +
      labels[i] +
      '</button>';
