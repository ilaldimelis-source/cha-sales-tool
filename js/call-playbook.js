...
var NEO_SMART_CHOICE_FULL = [
  'NEO Smart Choice ✖ ( DO NOT ASK IF THEY ARE STILL THERE) Alright [Customer Name], I have some excellent news for you. Based on the information you provided, I was able to locate a plan for you through the First Health EPO Network. This plan offers fixed benefits for doctor visits, hospital care, and prescription savings. You have the flexibility to see any provider within the network, and ',
  "there's no requirement for referrals to visit a specialist. Another key advantage is nationwide access—this coverage can be used anywhere the network is accepted. Coverage outside of the network is limited to emergency situations. Does everything sound clear so far? ▶ ( Wait for Answer ) Great. Based on everything we've reviewed, the monthly rate for this plan comes out to $___. There is a one-time standard enrollment fee of $___ to activate your membership within the plan. That brings the total for the first month to $___, and then moving forward, your monthly cost is simply $___ thereafter. Now, assuming this plan meets your medical needs, would the initial first-month amount of $___ be affordable for you today? ▶ ( Wait for answer ) Perfect. What I'll do next is walk you through the full benefits of the program. If everything looks good to you, we'll move forward with submitting the application to the insurance company. During the verification process, you'll receive an email that includes an outline of your coverage along with digital insurance cards. Your physical cards will then arrive by mail within approximately one to three weeks. Okay? ▶ ( Wait for answer ) Let's start by reviewing how your doctor visits work so you can see how the plan functions, and then—if everything looks good—we'll move forward with submitting the application. Sounds good? ▶ ( Wait for answer ) You don't need referrals to see a specialist. When you visit a doctor for preventative or wellness care such as an annual physical, routine screening, mammogram, colonoscopy, or pap smear, the plan will cover these services 100% as long as you are in network. When you visit a primary physician you will have a $40.00 co-pay. When you visit a specialist you will have a $50.00 co-pay. When you visit an Urgent Care you will have a $60.00 co-pay. Your deductible will come into play in the event of hospitalization or surgery. For those services you have a $1,500/ $2,500/ $3,000 /$3,500 deductible, as well as a Maximum out of Pocket of $9,200.00. How is this sounding so far? This is nice for peace of mind in case something unexpected comes up. Sounds good? ✖ ( DO NOT WAIT - GO TO RX ) RX: For prescriptions, preferred generic medications have a $12 copay at participating retail pharmacies. For brand-name medications, you'll also receive a prescription savings card that can help reduce costs, depending on the medication. ✖ ( DO NOT WAIT GO RIGHT TO CLOSING STATEMENT ) I do want to clarify that this is a private short term plan, not an ACA or major medical plan, and it does not provide coverage for maternity, substance abuse, or psychiatric services. CLOSING STATEMENT Your coverage is scheduled to start on ______, pending enrollment and verification. You can see in-network providers with no referral required, and the plan includes day-to-day benefits and fixed hospital benefits. Before we proceed, can you confirm that everything we've reviewed about the plan and its limitations has been explained and understood? ▶ ( Wait for Answer ) OK Perfect, what is a good email we can send all this over to? Would you like your insurance cards issued with a middle initial, or just your first and last name? What is the physical mailing address where we should send your hard-copy documents to? Great. And just to confirm, is this phone number ________ the best number for the insurance company to reach you if they have any follow-up or verification questions? Before we complete the enrollment, I do need to verify a few items on this recorded line. Can you please confirm that you are a United States citizen or legal resident, and that all health information you provided today is accurate and complete to the best of your knowledge? Lastly, for identity verification purposes, please confirm your Social Security number? ▶ ( Wait for Answer ) For the initial payment, which card type would you prefer you put on file? ▶ ( Wait for Answer ) Ok go ahead with the card number. (OR) ",
  "I'm ready for the card number when you're ready. ✖ ( DO NOT SPEAK WHOEVER TALKS FIRST LOSES ) Verification This is the final step. I'm sending you a text now from a 848 number labeled 'ONE ENROLLMENT.' Please click the link once you receive it. Let me know when you see it. ▶ ( Wait for Answer ) Great. Please open the link and, if possible, place your phone on speaker so I can walk you through the document. Your role here is simply to confirm that everything has been entered correctly. I'll have you verify the spelling of your first and last name, your home address, email address, and phone number, as well as confirm that your date of birth and gender are accurate. I'll also ask you to confirm the payment method on file and the billing address associated with the application. Once you've reviewed everything, let me know—does it all look correct? ▶ ( Wait for Answer) As you scroll down, you'll see what's called a bill-by-benefit breakdown. It's just a transparent summary showing how the policy is set up and how the cost is allocated across the benefits. At the bottom, enter your first and last name—please capitalize both. Then sign electronically with your finger. You can leave the last checkbox unchecked unless you're applying for your child only. Click 'Accept' and tell me what you see. (You've successfully signed your document) Notes: ▶ If needed: Don't forget to enroll customer GoodRX Account. ▶ You will need a verification code from the customer. Via TEXT. ▶ Remind customer to use GoodRX and not their insurance card at the pharmacy. Customer provides pharmacist of their GoodRX Account. Post Close Perfect—I've received your signature on my end. I'm going to go ahead and submit your application to the insurance carrier now. ✔ ( If it goes through ) Congratulations [Customer Name], your application is complete. Do you have a pen and paper? Our customer service number is 855-736-1590, available Monday through Friday, 9:00 a.m. to 9:00 p.m. Eastern. I'll also provide you with my direct extension for future reference. Your confirmation number is CHA561337—please keep that for your records. If anyone calls claiming to be from our agency and can't provide that number, they're not affiliated with us. Now go ahead and write down FIRST HEALTH NETWORK. The website you can visit to search providers is: providerlocator.firsthealth.com With today's payment, your policy will become effective on _______. Your second payment will then be due 30 days from that effective date. ( If it's a postdate, make sure you state the dates correctly for the first billing date and the effective date ) You'll receive two ID cards by mail about 7 to 10 business days after your effective date. One is a discount card for prescriptions and other added benefits like dental and vision. The second card is your actual insurance ID card and will clearly show FIRST HEALTH NETWORK. Just for your records, I want to quickly recap the main details you'll see in your paperwork. Your plan uses the FirstHealth Network for doctors and hospitals. The insurance benefits are underwritten by Detego Health and offered through Population Science Management. Your monthly billing is handled through Neo Health Solutions, which is the name you'll see on your statements. All of this will be clearly outlined in your policy documents. - I also want to explain the 12 and 12 pre-existing condition clause, which states anything diagnosed in the last 12 months would have a 12-month waiting period. There is a standard 30-day waiting period for any hospital,sickness and scheduled doctor visits. If you need to add or change dependents in the future, that can be done at the plan's annual anniversary, without having to cancel your coverage. If you have any friends or family members that need quality coverage, please give them my information, it would be greatly appreciated. We will find them the right plan just as we did for you. Alright [Customer Name], you've been an absolute pleasure. Now do you have any questions before we disconnect? ✖ ( DO NOT ASK IF THEY ARE STILL THERE )"
].join('');
...
var PLAN_SCRIPTS = [
  ...
  },
  {
    ...
    sections: [
      {
        title: 'Complete NEO Smart Choice script',
        content: NEO_SMART_CHOICE_FULL
      }
    ]
  }
];
