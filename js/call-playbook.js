...
const CF_STEPS = [
  ...
  },
  {
    ...
    lines: [
      ...
      '[TDK 4/5 only] As you scroll through the document there will be acknowledgement boxes to check off — there should be 8 of them.',
...
var PLAN_SCRIPTS = [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        title: 'Verification',
        content:
          "This is the final step. I'm sending you a text now from a 732 number labeled 'ONE ENROLLMENT.' Please click the link once you receive it. Let me know when you see it.\n▶ ( Wait for Answer )\n\nGreat. Please open the link and, if possible, place your phone on speaker so I can walk you through the document. Your role here is simply to confirm that everything has been entered correctly. I'll have you verify the spelling of your first and last name, your home address, email address, and phone number, as well as confirm that your date of birth and gender are accurate. I'll also ask you to confirm the payment method on file and the billing address associated with the application. Once you've reviewed everything, let me know—does it all look correct?\n▶ ( Wait for Answer)\n\nAs you scroll down, you'll see what's called a bill-by-benefit breakdown. It's just a transparent summary showing how the policy is set up and how the cost is allocated across the benefits.\n\nAt the bottom, enter your first and last name—please capitalize both. Then sign electronically with your finger. You can leave the last checkbox unchecked unless you're applying for your child only. Click 'Accept' and tell me what you see.\n\n(You've successfully signed your document)\n\nNotes:\n- If needed: Don't forget to enroll customer GoodRX Account.\n- You will need a verification code from the customer. Via TEXT.\n- Remind customer to use GoodRX and not their insurance card at the pharmacy. Customer provides pharmacist of their GoodRX Account."
      },
      {
        title: 'Post Close',
        content:
          "Perfect—I've received your signature on my end. I'm going to go ahead and submit your application to the insurance carrier now.\n✔ ( If it goes through )\n\nCongratulations [Customer Name], your application is complete. Do you have a pen and paper? Our customer service number is 855-736-1590, available Monday through Friday, 9:00 a.m. to 9:00 p.m. Eastern. I'll also provide you with my direct extension for future reference.\n\nYour confirmation number is CHA561337—please keep that for your records. If anyone calls claiming to be from our agency and can't provide that number, they're not affiliated with us.\n\nNow go ahead and write down MULTIPLAN PHCS NETWORK.\n\nThe website you can visit to search providers is: providersearch.multiplan.com\n\nWith today's payment, your policy will become effective on _______. Your second payment will then be due 30 days from that effective date.\n( If it's a postdate, make sure you state the dates correctly for the first billing date and the effective date )\n\nYou'll receive two ID cards by mail about 7 to 10 business days after your effective date. One is a discount card for prescriptions and other added benefits like dental and vision. The second card is your actual insurance ID card and will clearly show MULTIPLAN PHCS NETWORK.\n\nJust for your records, I want to quickly recap the main details you'll see in your paperwork. Your plan uses the Multiplan PHCS Network for doctors and hospitals.\n\nThe insurance benefits are underwritten by American Financial Security Life Insurance Company and offered through the National Congress of Employers (NCE).\n\nYour monthly billing is handled through FirstEnroll, which is the name you'll see on your statements. All of this will be clearly outlined in your policy documents.\n\nI do want to clarify that this is a private, short term health plan, not an ACA or major medical plan, and it does not provide coverage for maternity, substance abuse, or psychiatric services.\n\nI also want to explain the 12 and 12 pre-existing condition clause, which states anything diagnosed in the last 12 months would have a 12-month waiting period. There is a standard 30-day waiting period for any hospital, sickness and scheduled doctor visits.\n\nIf you need to add or change dependents in the future, that can be done on the plan's annual anniversary, without having to cancel your coverage.\n\nIf you have any friends or family members that need quality coverage, please give them my information, it would be greatly appreciated. We will find them the right plan just as we did for you.\n\nAlright [Customer Name], you've been an absolute pleasure. Now do you have any questions before we disconnect?"
      }
    ]
  },
  {
    ...
    sections: [
      ...
      },
      {
        title: 'Post Close',
        content:
          "Perfect—I've received your signature on my end. I'm going to go ahead and submit your application to the insurance carrier now.\n✔ ( If it goes through )\n\nCongratulations [Customer Name], your application is complete. Do you have a pen and paper? Our customer service number is 855-736-1590, available Monday through Friday, 9:00 a.m. to 9:00 p.m. Eastern. I'll also provide you with my direct extension for future reference.\n\nYour confirmation number is CHA561337—please keep that for your records. If anyone calls claiming to be from our agency and can't provide that number, they're not affiliated with us.\n\nNow go ahead and write down FIRST HEALTH NETWORK.\n\nThe website you can visit to search providers is: providerlocator.firsthealth.com\n\nWith today's payment, your policy will become effective on _______. Your second payment will then be due 30 days from that effective date.\n( If it's a postdate, make sure you state the dates correctly for the first billing date and the effective date )\n\nJust for your records, I want to quickly recap the main details you'll see in your paperwork. Your plan uses the FirstHealth Network for doctors and hospitals.\n\nThe Plan Administrator / Claims Administrator: Merchants Benefit Administration (MBA)\n\nYour monthly billing is handled through FirstEnroll, which is the name you'll see on your statements. All of this will be clearly outlined in your policy documents.\n\nMedFirst/GoodHealth/ ▶ ( Say whatever plan you're selling ) is a limited-benefit MEC. It is NOT an ACA plan nor a major-medical or comprehensive coverage. It has a $0 deductible and no out-of-pocket maximum and it does not provide coverage for maternity, substance abuse, or psychiatric services.\n\nI also want to explain the 12 and 12 pre-existing condition clause, which states anything diagnosed in the last 12 months would have a 12-month waiting period. There is a standard 30-day waiting period for any hospital, sickness and scheduled doctor visits.\n\nIf you have any friends or family members that need quality coverage, please give them my information, it would be greatly appreciated. We will find them the right plan just as we did for you.\n\nAlright [Customer Name], you've been an absolute pleasure. Now do you have any questions before we disconnect?"
      }
    ]
  },
  {
    ...
    sections: [
      {
        title: 'Opening & Benefits',
        content:
          "✖ ( DO NOT ASK IF THEY ARE STILL THERE )\nAlright [Customer Name], I have some excellent news for you. Based on the information you provided, I was able to locate a plan for you through the FirstHealth Network. This plan offers fixed benefits for doctor visits, hospital care, and prescription savings. You have the flexibility to see any provider within the network, and there's no requirement for referrals to visit a specialist. Another key advantage is nationwide access—this coverage can be used anywhere the network is accepted. And most importantly, there is no deductible. Does everything sound clear so far?\n▶ ( Wait for Answer )\n\nGreat. Based on everything we've reviewed, the monthly rate for this plan comes out to $___. There is a one-time standard group association fee of $___ to activate your membership within the plan. That brings the total for the first month to $___, and then moving forward, your monthly cost is simply $___ thereafter. Now, assuming this plan meets your medical needs, would the initial first-month amount of $___ be affordable for you today?\n▶ ( Wait for answer )\n\nPerfect. What I'll do next is walk you through the full benefits of the program. If everything looks good to you, we'll move forward with submitting the application to the insurance company. During the verification process, you'll receive an email that includes an outline of your coverage along with digital insurance cards. Your physical cards will then arrive by mail within approximately one to three weeks. Okay?\n▶ ( Wait for answer )\n\nPerfect. Let's start by reviewing how your doctor visits work so you can see how the plan functions, and then—if everything looks good—we'll move forward with submitting the application. Sounds good?\n▶ ( Wait for answer )\n\nYou don't need referrals to see a specialist. When you visit a primary physician you will have a $50.00 co-pay. When you visit a specialist/Urgent Care you will have a $75.00 co-pay. People like this plan because it's simple. Unlike traditional plans with deductibles and coinsurance, this plan has no deductible and pays defined benefit amounts toward covered services—so you know what the plan contributes and can plan your expenses more easily.\n✖ ( DO NOT WAIT - GO TO RX )"
      },
      {
        title: 'Prescription (RX)',
        content:
      ...
      },
      {
        title: 'Verification',
        content:
          "This is the final step. I'm sending you a text now from a 732 number labeled 'ONE ENROLLMENT.' Please click the link once you receive it. Let me know when you see it.\n▶ ( Wait for Answer )\n\nGreat. Please open the link and, if possible, place your phone on speaker so I can walk you through the document. Your role here is simply to confirm that everything has been entered correctly. I'll have you verify the spelling of your first and last name, your home address, email address, and phone number, as well as confirm that your date of birth and gender are accurate. I'll also ask you to confirm the payment method on file and the billing address associated with the application. Once you've reviewed everything, let me know—does it all look correct?\n▶ ( Wait for Answer)\n\nAs you scroll down, you'll see what's called a bill-by-benefit breakdown. It's just a transparent summary showing how the policy is set up and how the cost is allocated across the benefits.\n\nAs you scroll through the document there will be acknowledgement boxes that you will need to check off, there should be 8 of them.\n\nAt the bottom, enter your first and last name—please capitalize both. Then sign electronically with your finger. You can leave the last checkbox unchecked unless you're applying for your child only. Click 'Accept' and tell me what you see.\n\n(You've successfully signed your document)\n\nNotes:\n- If needed: Don't forget to enroll customer GoodRX Account.\n- You will need a verification code from the customer. Via TEXT.\n- Remind customer to use GoodRX and not their insurance card at the pharmacy. Customer provides pharmacist of their GoodRX Account."
      },
      {
        title: 'Post Close',
        content:
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        title: 'Verification',
        content:
          "This is the final step. I'm sending you a text now from a 732 number labeled 'ONE ENROLLMENT.' Please click the link once you receive it. Let me know when you see it.\n▶ ( Wait for Answer )\n\nGreat. Please open the link and, if possible, place your phone on speaker so I can walk you through the document. Your role here is simply to confirm that everything has been entered correctly. I'll have you verify the spelling of your first and last name, your home address, email address, and phone number, as well as confirm that your date of birth and gender are accurate. I'll also ask you to confirm the payment method on file and the billing address associated with the application. Once you've reviewed everything, let me know—does it all look correct?\n▶ ( Wait for Answer)\n\nAs you scroll down, you'll see what's called a bill-by-benefit breakdown. It's just a transparent summary showing how the policy is set up and how the cost is allocated across the benefits.\n\nYou will also see the specific name of the plan through the First Health Network (TDK 1,2,3) which stands for Transforming Data to Knowledge which is administered through Detego Health which processes the claims for your Health Data Analytics.\n\nAs you scroll through the document there will be acknowledgement boxes that you will need to check off, there should be 8 of them.\n\nAt the bottom, enter your first and last name—please capitalize both. Then sign electronically with your finger. You can leave the last checkbox unchecked unless you're applying for your child only. Click 'Accept' and tell me what you see.\n\n(You've successfully signed your document)\n\nNotes:\n- If needed: Don't forget to enroll customer GoodRX Account.\n- You will need a verification code from the customer. Via TEXT.\n- Remind customer to use GoodRX and not their insurance card at the pharmacy. Customer provides pharmacist of their GoodRX Account."
      },
      {
        title: 'Post Close',
        content:
          "Perfect—I've received your signature on my end. I'm going to go ahead and submit your application to the insurance carrier now.\n✔ ( If it goes through )\n\nCongratulations [Customer Name], your application is complete. Do you have a pen and paper? Our customer service number is 855-736-1590, available Monday through Friday, 9:00 a.m. to 9:00 p.m. Eastern. I'll also provide you with my direct extension for future reference.\n\nYour confirmation number is CHA561337—please keep that for your records. If anyone calls claiming to be from our agency and can't provide that number, they're not affiliated with us.\n\nNow go ahead and write down FIRST HEALTH NETWORK.\n\nThe website you can visit to search providers is: providerlocator.firsthealth.com\n\nWith today's payment, your policy will become effective on _______. Your second payment will then be due 30 days from that effective date.\n( If it's a postdate, make sure you state the dates correctly for the first billing date and the effective date )\n\nJust for your records, I want to quickly recap the main details you'll see in your paperwork. Your plan uses the FirstHealth Network for doctors and hospitals.\n\nThe Plan Administrator / Claims Administrator: Detego Health\n\nYour monthly billing is handled through FirstEnroll / NEO Insurance Solutions, which is the name you'll see on your statements. All of this will be clearly outlined in your policy documents.\n\nTDK is a limited-benefit MEC group health plan through the HCDA Working Owner program. It is NOT an ACA plan nor a major-medical or comprehensive coverage. It has a $0 deductible and no out-of-pocket maximum and it does not provide coverage for maternity, substance abuse, or psychiatric services.\n\nI also want to explain the 12 and 12 pre-existing condition clause, which states anything diagnosed in the last 12 months would have a 12-month waiting period. There is a standard 30-day waiting period for any hospital, sickness and scheduled doctor visits.\n\nIf you have any friends or family members that need quality coverage, please give them my information, it would be greatly appreciated. We will find them the right plan just as we did for you.\n\nAlright [Customer Name], you've been an absolute pleasure. Now do you have any questions before we disconnect?"
      }
    ]
  },
  {
    ...
    sections: [
      ...
      },
      {
        title: 'Verification',
        content:
          "This is the final step. I'm sending you a text now from a 732 number labeled 'ONE ENROLLMENT.' Please click the link once you receive it. Let me know when you see it.\n▶ ( Wait for Answer )\n\nGreat. Please open the link and, if possible, place your phone on speaker so I can walk you through the document. Your role here is simply to confirm that everything has been entered correctly. I'll have you verify the spelling of your first and last name, your home address, email address, and phone number, as well as confirm that your date of birth and gender are accurate. I'll also ask you to confirm the payment method on file and the billing address associated with the application. Once you've reviewed everything, let me know—does it all look correct?\n▶ ( Wait for Answer)\n\nAs you scroll down, you'll see what's called a bill-by-benefit breakdown. It's just a transparent summary showing how the policy is set up and how the cost is allocated across the benefits.\n\nYou will also see the specific name of the plan through the First Health Network (TDK 4,5) which stands for Transforming Data to Knowledge which is administered through Detego Health which processes the claims for your Health Data Analytics.\n\nAs you scroll through the document there will be acknowledgement boxes that you will need to check off, there should be 8 of them.\n\nAt the bottom, enter your first and last name—please capitalize both. Then sign electronically with your finger. You can leave the last checkbox unchecked unless you're applying for your child only. Click 'Accept' and tell me what you see.\n\n(You've successfully signed your document)\n\nNotes:\n- If needed: Don't forget to enroll customer GoodRX Account.\n- You will need a verification code from the customer. Via TEXT.\n- Remind customer to use GoodRX and not their insurance card at the pharmacy. Customer provides pharmacist of their GoodRX Account."
      },
      {
        title: 'Post Close',
        content:
    ...
    sections: [
      {
        title: 'Opening & Benefits',
        content:
          "✖ ( DO NOT ASK IF THEY ARE STILL THERE )\nAlright [Customer Name], I have some excellent news for you. Based on the information you provided, I was able to locate a plan for you through the Managed Care Network. This plan offers fixed benefits for doctor visits, hospital care, and prescription savings. You have the flexibility to see any provider within the network, and there's no requirement for referrals to visit a specialist. Another key advantage is nationwide access—this coverage can be used anywhere the network is accepted. And most importantly, there is no deductible. Does everything sound clear so far?\n▶ ( Wait for Answer )\n\nGreat. Based on everything we've reviewed, the monthly rate for this plan comes out to $___. There is a one-time standard group association fee of $___ to activate your membership within the plan. That brings the total for the first month to $___, and then moving forward, your monthly cost is simply $___ thereafter. Now, assuming this plan meets your medical needs, would the initial first-month amount of $___ be affordable for you today?\n▶ ( Wait for answer )\n\nPerfect. What I'll do next is walk you through the full benefits of the program. If everything looks good to you, we'll move forward with submitting the application to the insurance company. During the verification process, you'll receive an email that includes an outline of your coverage along with digital insurance cards. Your physical cards will then arrive by mail within approximately one to three weeks. Okay?\n▶ ( Wait for answer )\n\nPerfect. Let's start by reviewing how your doctor visits work so you can see how the plan functions, and then—if everything looks good—we'll move forward with submitting the application. Sounds good?\n▶ ( Wait for answer )\n\nYou don't need referrals to see a specialist. When you visit a primary physician you will have a $25.00 pre-pay. When you visit a specialist you will have a $50.00 pre-pay. People like this plan because it's simple. Unlike traditional plans with deductibles and coinsurance, this plan has no deductible and pays defined benefit amounts toward covered services—so you know what the plan contributes and can plan your expenses more easily.\n✖ ( DO NOT WAIT - GO TO RX )"
      },
      {
        title: 'Prescription (RX)',
        content:
      ...
      },
      {
        title: 'Verification',
        content:
          "This is the final step. I'm sending you a text now from a 732 number labeled 'ONE ENROLLMENT.' Please click the link once you receive it. Let me know when you see it.\n▶ ( Wait for Answer )\n\nGreat. Please open the link and, if possible, place your phone on speaker so I can walk you through the document. Your role here is simply to confirm that everything has been entered correctly. I'll have you verify the spelling of your first and last name, your home address, email address, and phone number, as well as confirm that your date of birth and gender are accurate. I'll also ask you to confirm the payment method on file and the billing address associated with the application. Once you've reviewed everything, let me know—does it all look correct?\n▶ ( Wait for Answer)\n\nAs you scroll down, you'll see what's called a bill-by-benefit breakdown. It's just a transparent summary showing how the policy is set up and how the cost is allocated across the benefits.\n\nAs you scroll through the document there will be acknowledgement boxes that you will need to check off, there should be 13 of them.\n\nAt the bottom, enter your first and last name—please capitalize both. Then sign electronically with your finger. You can leave the last checkbox unchecked unless you're applying for your child only. Click 'Accept' and tell me what you see.\n\n(You've successfully signed your document)\n\nNotes:\n- If needed: Don't forget to enroll customer GoodRX Account.\n- You will need a verification code from the customer. Via TEXT.\n- Remind customer to use GoodRX and not their insurance card at the pharmacy. Customer provides pharmacist of their GoodRX Account."
      },
      {
        title: 'Post Close',
        content:
          "Perfect—I've received your signature on my end. I'm going to go ahead and submit your application to the insurance carrier now.\n✔ ( If it goes through )\n\nCongratulations [Customer Name], your application is complete. Do you have a pen and paper? Our customer service number is 855-736-1590, available Monday through Friday, 9:00 a.m. to 9:00 p.m. Eastern. I'll also provide you with my direct extension for future reference.\n\nYour confirmation number is CHA561337—please keep that for your records. If anyone calls claiming to be from our agency and can't provide that number, they're not affiliated with us.\n\nNow go ahead and write down Managed Care Network.\n\nWith today's payment, your policy will become effective on _______. Your second payment will then be due 30 days from that effective date.\n( If it's a postdate, make sure you state the dates correctly for the first billing date and the effective date )\n\nJust for your records, I want to quickly recap the main details you'll see in your paperwork. Your plan uses the Managed Care Network for doctors and hospitals.\n\nThe insurance benefits are underwritten by BCS Insurance Company and offered through the Business Workers of America.\n\nYour monthly billing is handled through FirstEnroll, which is the name you'll see on your statements. All of this will be clearly outlined in your policy documents.\n\nI do want to clarify that this is a private, limited-benefit plan, not an ACA or major medical plan, and it does not provide coverage for maternity, substance abuse, or psychiatric services.\n\nI also want to explain the 12 and 12 pre-existing condition clause, which states anything diagnosed in the last 12 months would have a 12-month waiting period. There is a standard 30-day waiting period for any hospital, sickness and scheduled doctor visits.\n\nIf you have any friends or family members that need quality coverage, please give them my information, it would be greatly appreciated. We will find them the right plan just as we did for you.\n\nAlright [Customer Name], you've been an absolute pleasure. Now do you have any questions before we disconnect?"
      }
    ]
  },
  {
    ...
    sections: [
      {
        title: 'Opening & Benefits',
        content:
          "✖ ( DO NOT ASK IF THEY ARE STILL THERE )\nAlright [Customer Name], I have some excellent news for you. Based on the information you provided, I was able to locate a plan for you through the PHCS PPO NETWORK that stands for Private HealthCare Systems. This plan offers fixed benefits for doctor visits, hospital care, and prescription savings. You have the flexibility to see any provider within the network, and there's no requirement for referrals to visit a specialist. Another key advantage is nationwide access—this coverage can be used anywhere the network is accepted. And most importantly, there is no deductible. Does everything sound clear so far?\n▶ ( Wait for Answer )\n\nGreat. Based on everything we've reviewed, the monthly rate for this plan comes out to $___. There is a one-time standard group association fee of $___ to activate your membership within the plan. That brings the total for the first month to $___, and then moving forward, your monthly cost is simply $___ thereafter. Now, assuming this plan meets your medical needs, would the initial first-month amount of $___ be affordable for you today?\n▶ ( Wait for answer )\n\nPerfect. What I'll do next is walk you through the full benefits of the program. If everything looks good to you, we'll move forward with submitting the application to the insurance company. During the verification process, you'll receive an email that includes an outline of your coverage along with digital insurance cards. Your physical cards will then arrive by mail within approximately one to three weeks. Okay?\n▶ ( Wait for answer )\n\nPerfect. Let's start by reviewing how your doctor visits work so you can see how the plan functions, and then—if everything looks good—we'll move forward with submitting the application. Sounds good?\n▶ ( Wait for answer )\n\nYou don't need referrals to see a specialist. When you visit a primary physician you will have a $25.00 pre-pay. When you visit a specialist you will have a $50.00 pre-pay. People like this plan because it's simple. Unlike traditional plans with deductibles and coinsurance, this plan has no deductible and pays defined benefit amounts toward covered services—so you know what the plan contributes and can plan your expenses more easily.\n✖ ( DO NOT WAIT - GO TO RX )"
      },
      {
        title: 'Prescription (RX)',
        content:
      ...
      },
      {
        title: 'Post Close',
        content:
          "Perfect—I've received your signature on my end. I'm going to go ahead and submit your application to the insurance carrier now.\n✔ ( If it goes through )\n\nCongratulations [Customer Name], your application is complete. Do you have a pen and paper? Our customer service number is 855-736-1590, available Monday through Friday, 9:00 a.m. to 9:00 p.m. Eastern. I'll also provide you with my direct extension for future reference.\n\nYour confirmation number is CHA561337—please keep that for your records. If anyone calls claiming to be from our agency and can't provide that number, they're not affiliated with us.\n\nNow go ahead and write down PHCS NETWORK.\n\nWith today's payment, your policy will become effective on _______. Your second payment will then be due 30 days from that effective date.\n( If it's a postdate, make sure you state the dates correctly for the first billing date and the effective date )\n\nJust for your records, I want to quickly recap the main details you'll see in your paperwork. Your plan uses the PHCS NETWORK for doctors and hospitals.\n\nThe insurance benefits are underwritten by American Public Life and offered through the Business Workers of America.\n\nYour monthly billing is handled through FirstEnroll, which is the name you'll see on your statements. All of this will be clearly outlined in your policy documents.\n\nI do want to clarify that this is a private, limited-benefit plan, not an ACA or major medical plan, and it does not provide coverage for maternity, substance abuse, or psychiatric services.\n\nI also want to explain the 12 and 12 pre-existing condition clause, which states anything diagnosed in the last 12 months would have a 12-month waiting period. There is a standard 30-day waiting period for any hospital, sickness and scheduled doctor visits.\n\nIf you have any friends or family members that need quality coverage, please give them my information, it would be greatly appreciated. We will find them the right plan just as we did for you.\n\nAlright [Customer Name], you've been an absolute pleasure. Now do you have any questions before we disconnect?"
      }
    ]
  },
  {
    ...
    sections: [
      {
        title: 'Opening & Benefits',
        content:
          "✖ ( DO NOT ASK IF THEY ARE STILL THERE )\nAlright [Customer Name], I have some excellent news for you. Based on the information you provided, I was able to locate a plan for you through the Multiplan Network. This plan offers fixed benefits for doctor visits, hospital care, and prescription savings. You have the flexibility to see any provider within the network, and there's no requirement for referrals to visit a specialist. Another key advantage is nationwide access—this coverage can be used anywhere the network is accepted. And most importantly, there is no deductible. Does everything sound clear so far?\n▶ ( Wait for Answer )\n\nGreat. Based on everything we've reviewed, the monthly rate for this plan comes out to $___. There is a one-time standard group association fee of $___ to activate your membership within the plan. That brings the total for the first month to $___, and then moving forward, your monthly cost is simply $___ thereafter. Now, assuming this plan meets your medical needs, would the initial first-month amount of $___ be affordable for you today?\n▶ ( Wait for answer )\n\nPerfect. What I'll do next is walk you through the full benefits of the program. If everything looks good to you, we'll move forward with submitting the application to the insurance company. During the verification process, you'll receive an email that includes an outline of your coverage along with digital insurance cards. Your physical cards will then arrive by mail within approximately one to three weeks. Okay?\n▶ ( Wait for answer )\n\nPerfect. Let's start by reviewing how your doctor visits work so you can see how the plan functions, and then—if everything looks good—we'll move forward with submitting the application. Sounds good?\n▶ ( Wait for answer )\n\nYou don't need referrals to see a specialist. When you visit a doctor, the bill is first reduced to the network's contracted rate, and then your doctor visit benefit is applied. So if a provider bills higher, the network adjusts it first, and your benefit helps cover the cost after that.\n▶ ( Wait for Answer )\n\nPeople like this plan because it's simple. Unlike traditional plans with deductibles and coinsurance, this plan has no deductible and pays defined benefit amounts toward covered services—so you know what the plan contributes and can plan your expenses more easily.\n✖ ( DO NOT WAIT - GO TO RX )"
      },
      {
        title: 'Prescription (RX)',
        content:
      ...
      },
      {
        title: 'Post Close',
        content:
          "Perfect—I've received your signature on my end. I'm going to go ahead and submit your application to the insurance carrier now.\n✔ ( If it goes through )\n\nCongratulations [Customer Name], your application is complete. Do you have a pen and paper? Our customer service number is 855-736-1590, available Monday through Friday, 9:00 a.m. to 9:00 p.m. Eastern. I'll also provide you with my direct extension for future reference.\n\nYour confirmation number is CHA561337—please keep that for your records. If anyone calls claiming to be from our agency and can't provide that number, they're not affiliated with us.\n\nNow go ahead and write down MULTIPLAN NETWORK.\n\nThe website you can visit to search providers is: providersearch.multiplan.com\n\nWith today's payment, your policy will become effective on _______. Your second payment will then be due 30 days from that effective date.\n( If it's a postdate, make sure you state the dates correctly for the first billing date and the effective date )\n\nYou'll receive two ID cards by mail about 7 to 10 business days after your effective date. One is a discount card for prescriptions and other added benefits like dental and vision. The second card is your actual insurance ID card and will clearly show MULTIPLAN NETWORK.\n\nJust for your records, I want to quickly recap the main details you'll see in your paperwork. Your plan uses the Multiplan Network for doctors and hospitals.\n\nThe insurance benefits are underwritten by American Financial Security Life Insurance Company and offered through the National Congress of Employers (NCE).\n\nYour monthly billing is handled through FirstEnroll, which is the name you'll see on your statements. All of this will be clearly outlined in your policy documents.\n\nI do want to clarify that this is a private, limited-benefit plan, not an ACA or major medical plan, and it does not provide coverage for maternity, substance abuse, or psychiatric services.\n\nI also want to explain the 12 and 12 pre-existing condition clause, which states anything diagnosed in the last 12 months would have a 12-month waiting period. There is a standard 30-day waiting period for any hospital, sickness and scheduled doctor visits.\n\nIf you have any friends or family members that need quality coverage, please give them my information, it would be greatly appreciated. We will find them the right plan just as we did for you.\n\nAlright [Customer Name], you've been an absolute pleasure. Now do you have any questions before we disconnect?"
      }
    ]
  },
  {
    ...
    sections: [
      {
        title: 'Opening & Medical Underwriting',
        content:
          "✖ ( DO NOT ASK IF THEY ARE STILL THERE )\nAlright [Customer Name], I have some excellent news for you. Based on the information you provided, I was able to locate a plan for you through AWA Americas Workers Association which uses the Multiplan PHCS Network. You have the flexibility to see any provider within the network, and there's no requirement for referrals to visit a specialist. You are going to receive coverage for doctors visits, blood and lab work, urgent care, medical, surgical, hospital, and emergency room coverage. This plan requires medical underwriting and has a set deductible of $__________.\n\nIn order to determine eligibility I will read you a list of 15 conditions. Please confirm if you currently have or if you've ever been diagnosed with the following conditions:\n\nHeart Disorder, Stroke, Chron's Disease, Ulcerative Colitis, Liver or Kidney Disorder, Emphysema, COPD, Cancer or Tumor, Alcohol or Drug Abuse, HIV or AIDS, Multiple Sclerosis, Tuberculosis, Autism, Schizophrenia, Lupus, Bariatric or Weight Loss Surgery, Pregnancy?\n▶ ( Wait for Answer )\n\nGreat. Based on everything we've reviewed, the monthly rate for this plan comes out to $___. There is a one-time standard (AWA) association fee of $___ to activate your membership within the plan. (Americas Workers Association) That brings the total for the first month to $___, and then moving forward, your monthly cost is simply $___ thereafter. Now, assuming this plan meets your medical needs, would the initial first-month amount of $___ be affordable for you today?\n▶ ( Wait for answer )\n\nPerfect. What I'll do next is walk you through the full benefits of the program. If everything looks good to you, we'll move forward with submitting the application to the insurance company. During the verification process, you'll receive an email that includes an outline of your coverage along with digital insurance cards. Your physical cards will then arrive by mail within approximately one to three weeks. Okay?\n▶ ( Wait for answer)"
      },
      {
        title: 'Benefits & Copays',
        content:
          "For your doctor's visits, you'll have access to a large PHCS network and you do not need a referral to see a specialist. Every time you go to the doctor's office you'll have a co-pay for your visit. For primary doctors visits and urgent care it's a $50 co-pay and for your specialist visits it's a $50 co-pay. Those visits aren't subject to the deductible. Your deductible will generally come into play in the event of hospitalization or surgery. For those services you have a $_____ deductible and also an additional $500.00 deductible for the emergency room. Then after the deductible is met, you have 80/20 or 50/50 coinsurance with a Maximum out of Pocket of $5000 and with a cap of $1,000,000. How is this sounding so far?\n✖ ( DO NOT WAIT - GO TO RX )"
      },
      {
        title: 'Prescription (RX)',
        content:
      ...
      },
      {
        title: 'Verification',
        content:
          "This is the final step. I'm sending you a text now from an 848 number labeled 'ONE ENROLLMENT.' Please click the link once you receive it. Let me know when you see it.\n▶ ( Wait for Answer )\n\nGreat. Please open the link and, if possible, place your phone on speaker so I can walk you through the document. Your role here is simply to confirm that everything has been entered correctly. I'll have you verify the spelling of your first and last name, your home address, email address, and phone number, as well as confirm that your date of birth and gender are accurate. I'll also ask you to confirm the payment method on file and the billing address associated with the application. Once you've reviewed everything, let me know—does it all look correct?\n▶ ( Wait for Answer)\n\nAs you scroll down, you'll see what's called a bill-by-benefit breakdown. It's just a transparent summary showing how the policy is set up and how the cost is allocated across the benefits.\n\nAt the bottom, enter your first and last name—please capitalize both. Then sign electronically with your finger. You can leave the last checkbox unchecked unless you're applying for your child only. Click 'Accept' and tell me what you see.\n\n(You've successfully signed your document)\n\nNotes:\n- If needed: Don't forget to enroll customer GoodRX Account.\n- You will need a verification code from the customer. Via TEXT.\n- Remind customer to use GoodRX and not their insurance card at the pharmacy. Customer provides pharmacist of their GoodRX Account."
      },
      {
        title: 'Post Close',
        content:
          "Perfect—I've received your signature on my end. I'm going to go ahead and submit your application to the insurance carrier now.\n✔ ( If it goes through )\n\nCongratulations [Customer Name], your application is complete. Do you have a pen and paper? Our customer service number is 855-736-1590, available Monday through Friday, 9:00 a.m. to 9:00 p.m. Eastern. I'll also provide you with my direct extension for future reference.\n\nYour confirmation number is CHA561337—please keep that for your records. If anyone calls claiming to be from our agency and can't provide that number, they're not affiliated with us.\n\nNow go ahead and write down MULTIPLAN PHCS NETWORK.\n\nThe website you can visit to search providers is: providersearch.multiplan.com\n\nWith today's payment, your policy will become effective on _______. Your second payment will then be due 30 days from that effective date.\n( If it's a postdate, make sure you state the dates correctly for the first billing date and the effective date )\n\nYou'll receive two ID cards by mail about 7 to 10 business days after your effective date. One is a discount card for prescriptions and other added benefits like dental and vision. The second card is your actual insurance ID card and will clearly show MULTIPLAN PHCS NETWORK.\n\nJust for your records, I want to quickly recap the main details you'll see in your paperwork. Your plan uses the Multiplan PHCS Network for doctors and hospitals.\n\nThe insurance benefits are underwritten by Everest Reinsurance Company and offered through the AWA Americas Workers Association.\n\nYour monthly billing is handled through Neo Health Solutions, which is the name you'll see on your statements. All of this will be clearly outlined in your policy documents.\n\nI do want to clarify that this is a private, short term health plan, not an ACA or major medical plan, and it does not provide coverage for maternity, or substance abuse for drugs and alcohol.\n\nI also want to explain the 12 and 12 pre-existing condition clause, which states anything diagnosed in the last 12 months would have a 12-month waiting period. There is a standard 30-day waiting period for any hospital, sickness and scheduled doctor visits.\n\nIf you need to add or change dependents in the future, that can be done on the plan's annual anniversary, without having to cancel your coverage.\n\nIf you have any friends or family members that need quality coverage, please give them my information, it would be greatly appreciated. We will find them the right plan just as we did for you.\n\nAlright [Customer Name], you've been an absolute pleasure. Now do you have any questions before we disconnect?"
      }
    ]
  },
  {
    ...
    sections: [
      {
        title: 'Opening & Medical Underwriting',
        content:
          "✖ ( DO NOT ASK IF THEY ARE STILL THERE )\nAlright [Customer Name], I have some excellent news for you. Based on the information you provided, I was able to locate a plan for you through SGIC which uses the Multiplan PHCS Network. You have the flexibility to see any provider within the network, and there's no requirement for referrals to visit a specialist. You are going to receive coverage for doctors visits, blood and lab work, urgent care, medical, surgical, hospital, and emergency room coverage. This plan requires medical underwriting and has a set deductible of $__________.\n\nIn order to determine eligibility I will read you a list of 15 conditions. Please confirm if you currently have or if you've ever been diagnosed with the following conditions:\n\nHeart Disorder, Stroke, Chron's Disease, Ulcerative Colitis, Liver or Kidney Disorder, Emphysema, COPD, Cancer or Tumor, Alcohol or Drug Abuse, HIV or AIDS, Multiple Sclerosis, Tuberculosis, Autism, Schizophrenia, Lupus, Bariatric or Weight Loss Surgery, Pregnancy?\n▶ ( Wait for Answer )\n\nGreat. Based on everything we've reviewed, the monthly rate for this plan comes out to $___. There is a one-time standard (AWA) association fee of $___ to activate your membership within the plan. (Americas Workers Association) That brings the total for the first month to $___, and then moving forward, your monthly cost is simply $___ thereafter. Now, assuming this plan meets your medical needs, would the initial first-month amount of $___ be affordable for you today?\n▶ ( Wait for answer )\n\nPerfect. What I'll do next is walk you through the full benefits of the program. If everything looks good to you, we'll move forward with submitting the application to the insurance company. During the verification process, you'll receive an email that includes an outline of your coverage along with digital insurance cards. Your physical cards will then arrive by mail within approximately one to three weeks. Okay?\n▶ ( Wait for answer)"
      },
      {
        title: 'Benefits & Copays',
        content:
          "For your doctor's visits, you'll have access to a large PHCS network and you do not need a referral to see a specialist. Every time you go to the doctor's office you'll have a co-pay for your visit. For primary doctors visits it's a $40.00 co-pay and for your specialist visits it's a $60.00 co-pay. Those visits aren't subject to the deductible. Your deductible will generally come into play in the event of hospitalization or surgery. For those services you have a $_____ deductible, as well as 80/20, 70/30 or 50/50 coinsurance with a Maximum out of Pocket of $5000.00 or $10,000.00. How is this sounding so far?\n✖ ( DO NOT WAIT - GO TO RX )"
      },
      {
        title: 'Prescription (RX)',
        content:
      ...
      },
      {
        title: 'Post Close',
        content:
          "Perfect—I've received your signature on my end. I'm going to go ahead and submit your application to the insurance carrier now.\n✔ ( If it goes through )\n\nCongratulations [Customer Name], your application is complete. Do you have a pen and paper? Our customer service number is 855-736-1590, available Monday through Friday, 9:00 a.m. to 9:00 p.m. Eastern. I'll also provide you with my direct extension for future reference.\n\nYour confirmation number is CHA561337—please keep that for your records. If anyone calls claiming to be from our agency and can't provide that number, they're not affiliated with us.\n\nNow go ahead and write down MULTIPLAN NETWORK.\n\nThe website you can visit to search providers is: providersearch.multiplan.com\n\nWith today's payment, your policy will become effective on _______. Your second payment will then be due 30 days from that effective date.\n( If it's a postdate, make sure you state the dates correctly for the first billing date and the effective date )\n\nYou'll receive two ID cards by mail about 7 to 10 business days after your effective date. One is a discount card for prescriptions and other added benefits like dental and vision. The second card is your actual insurance ID card and will clearly show MULTIPLAN NETWORK.\n\nJust for your records, I want to quickly recap the main details you'll see in your paperwork. Your plan uses the Multiplan Network for doctors and hospitals.\n\nThe insurance benefits are underwritten by (SGIC) Southern Guarantee Insurance Company and offered through the Association for Responsible Partners.\n\nYour monthly billing is handled through Neo Health Solutions, which is the name you'll see on your statements. All of this will be clearly outlined in your policy documents.\n\nI do want to clarify that this is a private, short term health plan, not an ACA or major medical plan, and it does not provide coverage for maternity, substance abuse, or psychiatric services.\n\nI also want to explain the 12 and 12 pre-existing condition clause, which states anything diagnosed in the last 12 months would have a 12-month waiting period. There is a standard 30-day waiting period for any hospital, sickness and scheduled doctor visits.\n\nIf you need to add or change dependents in the future, that can be done on the plan's annual anniversary, without having to cancel your coverage.\n\nIf you have any friends or family members that need quality coverage, please give them my information, it would be greatly appreciated. We will find them the right plan just as we did for you.\n\nAlright [Customer Name], you've been an absolute pleasure. Now do you have any questions before we disconnect?"
      }
    ]
  },
  {
    name: 'AFRP Galena STM Standard',
    planType: 'STM',
    sections: [
      {
        title: 'Opening & Medical Underwriting',
      ...
      },
      {
        title: 'Post Close',
        content:
          "Perfect—I've received your signature on my end. I'm going to go ahead and submit your application to the insurance carrier now.\n✔ ( If it goes through )\n\nCongratulations [Customer Name], your application is complete. Do you have a pen and paper? Our customer service number is 855-736-1590, available Monday through Friday, 9:00 a.m. to 9:00 p.m. Eastern. I'll also provide you with my direct extension for future reference.\n\nYour confirmation number is CHA561337—please keep that for your records. If anyone calls claiming to be from our agency and can't provide that number, they're not affiliated with us.\n\nNow go ahead and write down MULTIPLAN NETWORK.\n\nThe website you can visit to search providers is: providersearch.multiplan.com\n\nWith today's payment, your policy will become effective on _______. Your second payment will then be due 30 days from that effective date.\n( If it's a postdate, make sure you state the dates correctly for the first billing date and the effective date )\n\nYou'll receive two ID cards by mail about 7 to 10 business days after your effective date. One is a discount card for prescriptions and other added benefits like dental and vision. The second card is your actual insurance ID card and will clearly show MULTIPLAN NETWORK.\n\nJust for your records, I want to quickly recap the main details you'll see in your paperwork. Your plan uses the Multiplan Network/ PHCS Network for doctors and hospitals.\n\nThe insurance benefits are underwritten by (SGIC) Southern Guarantee Insurance Company and offered through the Association for Responsible Partners.\n\nYour monthly billing is handled through Neo Health Solutions, which is the name you'll see on your statements. All of this will be clearly outlined in your policy documents.\n\nI do want to clarify that this is a private, short term health plan, not an ACA or major medical plan, and it does not provide coverage for maternity, substance abuse, or psychiatric services.\n\nI also want to explain the 12 and 12 pre-existing condition clause, which states anything diagnosed in the last 12 months would have a 12-month waiting period. There is a standard 30-day waiting period for any hospital, sickness and scheduled doctor visits.\n\nIf you need to add or change dependents in the future, that can be done on the plan's annual anniversary, without having to cancel your coverage.\n\nIf you have any friends or family members that need quality coverage, please give them my information, it would be greatly appreciated. We will find them the right plan just as we did for you.\n\nAlright [Customer Name], you've been an absolute pleasure. Now do you have any questions before we disconnect?"
      }
    ]
  },
  {
    name: 'AFRP Galena STM Economy',
    planType: 'STM',
    sections: [
      {
        title: 'Opening & Medical Underwriting',
      ...
      },
      {
        title: 'Benefits & Copays',
        content:
          "For your doctor's visits, you'll have access to a large PHCS network and you do not need a referral to see a specialist. Every time you go to the doctor's office you'll have a co-pay for your visit. For primary doctors visits it's a $40.00 co-pay and for your specialist visits it's a $60.00 co-pay. Your deductible will generally come into play in the event of Doctor visits, hospitalization or surgery. For those services you have a $_____ deductible, as well as 80/20, 70/30 or 50/50 coinsurance with a Maximum out of Pocket of $5000.00 or $10,000.00. How is this sounding so far?\n✖ ( DO NOT WAIT - GO TO RX )\n\nNOTE: Unlike Standard and Elite, on the Economy plan doctor visits ARE subject to the deductible."
      },
      {
        title: 'Prescription (RX)',
        content:
    ...
    sections: [
      {
        title: 'Opening & Medical Underwriting',
        content:
          "✖ ( DO NOT ASK IF THEY ARE STILL THERE )\nAlright [Customer Name], I have some excellent news for you. Based on the information you provided, I was able to locate a plan for you through (SLACIC) which uses the Multiplan PHCS Network. You have the flexibility to see any provider within the network, and there's no requirement for referrals to visit a specialist. You are going to receive coverage for doctors visits, blood and lab work, urgent care, medical, surgical, hospital, and emergency room coverage. This plan requires medical underwriting and has a set deductible of $__________.\n\nIn order to determine eligibility I will read you a list of 15 conditions. Please confirm if you currently have or if you've ever been diagnosed with the following conditions:\n\nHeart Disorder, Stroke, Chron's Disease, Ulcerative Colitis, Liver or Kidney Disorder, Emphysema, COPD, Cancer or Tumor, Alcohol or Drug Abuse, HIV or AIDS, Multiple Sclerosis, Tuberculosis, Autism, Schizophrenia, Lupus, Bariatric or Weight Loss Surgery, Pregnancy?\n▶ ( Wait for Answer )\n\nGreat. Based on everything we've reviewed, the monthly rate for this plan comes out to $___. There is a one-time standard association fee of $___ to activate your membership within the plan. That brings the total for the first month to $___, and then moving forward, your monthly cost is simply $___ thereafter. Now, assuming this plan meets your medical needs, would the initial first-month amount of $___ be affordable for you today?\n▶ ( Wait for answer )\n\nPerfect. What I'll do next is walk you through the full benefits of the program. If everything looks good to you, we'll move forward with submitting the application to the insurance company. During the verification process, you'll receive an email that includes an outline of your coverage along with digital insurance cards. Your physical cards will then arrive by mail within approximately one to three weeks. Okay?\n▶ ( Wait for answer)"
      },
      {
        title: 'Benefits & Copays',
        content:
          "For your doctor's visits, you'll have access to a large PHCS network and you do not need a referral to see a specialist. Every time you go to the doctor's office you'll have a co-pay for your visit. For primary doctors visits it's a $_____ co-pay and for your specialist visits it's a $____ co-pay. Those visits aren't subject to the deductible. Your deductible will generally come into play in the event of hospitalization or surgery. For those services you have a $_____ deductible, as well as 80/20 coinsurance with a Maximum out of Pocket of $2000.00 with a cap of $____.\n\nHow is this sounding so far?\n✖ ( DO NOT WAIT - GO TO RX )"
      },
      {
        title: 'Prescription (RX)',
        content:
      ...
      },
      {
        title: 'Post Close',
        content:
          "Perfect—I've received your signature on my end. I'm going to go ahead and submit your application to the insurance carrier now.\n✔ ( If it goes through )\n\nCongratulations [Customer Name], your application is complete. Do you have a pen and paper? Our customer service number is 855-736-1590, available Monday through Friday, 9:00 a.m. to 9:00 p.m. Eastern. I'll also provide you with my direct extension for future reference.\n\nYour confirmation number is CHA561337—please keep that for your records. If anyone calls claiming to be from our agency and can't provide that number, they're not affiliated with us.\n\nNow go ahead and write down PHCS Network.\n\nThe website you can visit to search providers is: providersearch.multiplan.com\n\nWith today's payment, your policy will become effective on _______. Your second payment will then be due 30 days from that effective date.\n( If it's a postdate, make sure you state the dates correctly for the first billing date and the effective date )\n\nYou'll receive two ID cards by mail about 7 to 10 business days after your effective date. One is a discount card for prescriptions and other added benefits like dental and vision. The second card is your actual insurance ID card and will clearly show MULTIPLAN PHCS NETWORK.\n\nJust for your records, I want to quickly recap the main details you'll see in your paperwork. Your plan uses the Multiplan Network/ PHCS Network for doctors and hospitals.\n\nThe insurance benefits are underwritten by (SLACIC) Standard Life and Casualty Insurance Company and offered through the (NCE) National Congress of Employers.\n\nYour monthly billing is handled through Neo Health Solutions, which is the name you'll see on your statements. All of this will be clearly outlined in your policy documents.\n\nI do want to clarify that this is a private, short term health plan, not an ACA or major medical plan, and it does not provide coverage for maternity, substance abuse, or psychiatric services.\n\nI also want to explain the 12 and 12 pre-existing condition clause, which states anything diagnosed in the last 12 months would have a 12-month waiting period. There is a standard 30-day waiting period for any hospital, sickness and scheduled doctor visits.\n\nIf you need to add or change dependents in the future, that can be done on the plan's annual anniversary, without having to cancel your coverage.\n\nIf you have any friends or family members that need quality coverage, please give them my information, it would be greatly appreciated. We will find them the right plan just as we did for you.\n\nAlright [Customer Name], you've been an absolute pleasure. Now do you have any questions before we disconnect?"
      }
    ]
  },
  {
    name: 'Smart Health STM Limited',
    planType: 'STM',
    sections: [
      {
        title: 'Opening & Medical Underwriting',
    ...
    sections: [
      {
        title: 'Opening & Benefits',
        content:
          "✖ ( DO NOT ASK IF THEY ARE STILL THERE)\nAlright [Customer Name], I have some excellent news for you. Based on the information you provided, I was able to locate a plan for you through the Multiplan PHCS Network. This plan offers fixed benefits for doctor visits, hospital care, and prescription savings. You have the flexibility to see any provider within the network, and there's no requirement for referrals to visit a specialist. Another key advantage is nationwide access—this coverage can be used anywhere the network is accepted. And most importantly, there is no deductible. Does everything sound clear so far?\n▶ ( Wait for Answer )\n\nGreat. Based on everything we've reviewed, the monthly rate for this plan comes out to $___. There is a one-time standard group association fee of $___ to activate your membership within the plan. That brings the total for the first month to $___, and then moving forward, your monthly cost is simply $___ thereafter. Now, assuming this plan meets your medical needs, would the initial first-month amount of $___ be affordable for you today?\n▶ ( Wait for answer )\n\nPerfect. What I'll do next is walk you through the full benefits of the program. If everything looks good to you, we'll move forward with submitting the application to the insurance company. During the verification process, you'll receive an email that includes an outline of your coverage along with digital insurance cards. Your physical cards will then arrive by mail within approximately one to three weeks. Okay?\n▶ ( Wait for answer )\n\nPerfect. Let's start by reviewing how your doctor visits work so you can see how the plan functions, and then—if everything looks good—we'll move forward with submitting the application. Sounds good?\n▶ ( Wait for answer )\n\nYou don't need referrals to see a specialist. When you visit a doctor, the bill is first reduced to the network's contracted rate, and then your doctor visit benefit is applied. So if a provider bills higher, the network adjusts it first, and your benefit helps cover the cost after that.\n▶ ( Wait for Answer )\n\nPeople like this plan because it's simple. Unlike traditional plans with deductibles and coinsurance, this plan has no deductible and pays defined benefit amounts toward covered services—so you know what the plan contributes and can plan your expenses more easily.\n✖ ( DO NOT WAIT - GO TO RX )"
      },
      {
        title: 'Prescription (RX)',
        content:
      ...
      },
      {
        title: 'Verification',
        content:
          "This is the final step. I'm sending you a text now from a 848 number labeled 'ONE ENROLLMENT.' Please click the link once you receive it. Let me know when you see it.\n▶ ( Wait for Answer )\n\nGreat. Please open the link and, if possible, place your phone on speaker so I can walk you through the document. Your role here is simply to confirm that everything has been entered correctly. I'll have you verify the spelling of your first and last name, your home address, email address, and phone number, as well as confirm that your date of birth and gender are accurate. I'll also ask you to confirm the payment method on file and the billing address associated with the application. Once you've reviewed everything, let me know—does it all look correct?\n▶ ( Wait for Answer)\n\nAs you scroll down, you'll see what's called a bill-by-benefit breakdown. It's just a transparent summary showing how the policy is set up and how the cost is allocated across the benefits.\n\nAt the bottom, enter your first and last name—please capitalize both. Then sign electronically with your finger. You can leave the last checkbox unchecked unless you're applying for your child only. Click 'Accept' and tell me what you see.\n\n(You've successfully signed your document)\n\nNotes:\n- If needed: Don't forget to enroll customer GoodRX Account.\n- You will need a verification code from the customer. Via TEXT.\n- Remind customer to use GoodRX and not their insurance card at the pharmacy. Customer provides pharmacist of their GoodRX Account."
      },
      {
        title: 'Post Close',
        content:
    ...
    sections: [
      {
        title: 'Opening & Benefits',
        content:
          "✖ ( DO NOT ASK IF THEY ARE STILL THERE)\nAlright [Customer Name], I have some excellent news for you. Based on the information you provided, I was able to locate a plan for you through Smart Choice which uses the First Health EPO Network. This plan offers fixed benefits for doctor visits, hospital care, and prescription savings. You have the flexibility to see any provider within the network, and there's no requirement for referrals to visit a specialist. Another key advantage is nationwide access—this coverage can be used anywhere the network is accepted. Coverage outside of the network is limited to emergency situations. Does everything sound clear so far?\n▶ ( Wait for Answer )\n\nGreat. Based on everything we've reviewed, the monthly rate for this plan comes out to $___. There is a one-time standard enrollment fee of $___ to activate your membership within the plan. That brings the total for the first month to $___, and then moving forward, your monthly cost is simply $___ thereafter. Now, assuming this plan meets your medical needs, would the initial first-month amount of $___ be affordable for you today?\n▶ ( Wait for answer )\n\nPerfect. What I'll do next is walk you through the full benefits of the program. If everything looks good to you, we'll move forward with submitting the application to the insurance company. During the verification process, you'll receive an email that includes an outline of your coverage along with digital insurance cards. Your physical cards will then arrive by mail within approximately one to three weeks. Okay?\n▶ ( Wait for answer )\n\nLet's start by reviewing how your doctor visits work so you can see how the plan functions, and then—if everything looks good—we'll move forward with submitting the application. Sounds good?\n▶ ( Wait for answer )"
      },
      {
        title: 'Doctor Visits & Copays',
        content:
          "You don't need referrals to see a specialist. When you visit a doctor for preventative or wellness care such as an annual physical, routine screening, mammogram, colonoscopy, or pap smear, the plan will cover these services 100% as long as you are in network.\n\nWhen you visit a primary physician you will have a $40.00 co-pay. When you visit a specialist you will have a $50.00 co-pay. When you visit an Urgent Care you will have a $60.00 co-pay.\n\nYour deductible will come into play in the event of hospitalization or surgery. For those services you have a $1,500/ $2,500/ $3,000 /$3,500 deductible, as well as a Maximum out of Pocket of $9,200.00.\n\nHow is this sounding so far? This is nice for peace of mind in case something unexpected comes up. Sounds good?\n✖ ( DO NOT WAIT - GO TO RX )"
      },
      {
        title: 'Prescription (RX)',
        content:
          "For prescriptions, preferred generic medications have a $12 copay at participating retail pharmacies. For brand-name medications, you'll also receive a prescription savings card that can help reduce costs, depending on the medication.\n✖ ( DO NOT WAIT GO RIGHT TO CLOSING STATEMENT )\n\nI do want to clarify that this is a private short term plan, not an ACA or major medical plan, and it does not provide coverage for maternity, substance abuse."
      },
      {
        title: 'Closing Statement',
        content:
          "Your coverage is scheduled to start on ______, pending enrollment and verification. You can see in-network providers with no referral required, and the plan includes day-to-day benefits and fixed hospital benefits. Before we proceed, can you confirm that everything we've reviewed about the plan and its limitations has been explained and understood?\n▶ ( Wait for Answer )\n\nOK Perfect, what is a good email we can send all this over to?\n\nWould you like your insurance cards issued with a middle initial, or just your first and last name?\n\nWhat is the physical mailing address where we should send your hard-copy documents to?\n\nGreat. And just to confirm, is this phone number ________ the best number for the insurance company to reach you if they have any follow-up or verification questions?\n\nBefore we complete the enrollment, I do need to verify a few items on this recorded line. Can you please confirm that you are a United States citizen or legal resident, and that all health information you provided today is accurate and complete to the best of your knowledge? Lastly, for identity verification purposes, please confirm your Social Security number?\n▶ ( Wait for Answer )\n\nFor the initial payment, which card type would you prefer you put on file?\n▶ ( Wait for Answer )\n\nOk go ahead with the card number. (OR) I'm ready for the card number when you're ready.\n✖ ( DO NOT SPEAK WHOEVER TALKS FIRST LOSES )"
      },
      {
        title: 'Verification',
        content:
      ...
      },
      {
        title: 'Post Close',
        content:
          "Perfect—I've received your signature on my end. I'm going to go ahead and submit your application to the insurance carrier now.\n✔ ( If it goes through )\n\nCongratulations [Customer Name], your application is complete. Do you have a pen and paper? Our customer service number is 855-736-1590, available Monday through Friday, 9:00 a.m. to 9:00 p.m. Eastern. I'll also provide you with my direct extension for future reference.\n\nYour confirmation number is CHA561337—please keep that for your records. If anyone calls claiming to be from our agency and can't provide that number, they're not affiliated with us.\n\nNow go ahead and write down FIRST HEALTH NETWORK.\n\nThe website you can visit to search providers is: providerlocator.firsthealth.com\n\nWith today's payment, your policy will become effective on _______. Your second payment will then be due 30 days from that effective date.\n( If it's a postdate, make sure you state the dates correctly for the first billing date and the effective date )\n\nYou'll receive two ID cards by mail about 7 to 10 business days after your effective date. One is a discount card for prescriptions and other added benefits like dental and vision. The second card is your actual insurance ID card and will clearly show FIRST HEALTH NETWORK.\n\nJust for your records, I want to quickly recap the main details you'll see in your paperwork. Your plan uses the FirstHealth Network for doctors and hospitals.\n\nThe plan benefits are administered by Detego Health and offered through Population Science Management.\n\nYour monthly billing is handled through Neo Health Solutions, which is the name you'll see on your statements. All of this will be clearly outlined in your policy documents.\n\nIf you have any friends or family members that need quality coverage, please give them my information, it would be greatly appreciated. We will find them the right plan just as we did for you.\n\nAlright [Customer Name], you've been an absolute pleasure. Now do you have any questions before we disconnect?\n✖ ( DO NOT ASK IF THEY ARE STILL THERE )"
      }
    ]
  },
  {
    ...
    sections: [
      {
        title: 'Opening & Medical Underwriting',
        content:
          "✖ ( DO NOT ASK IF THEY ARE STILL THERE ) Alright [Customer Name], I have some excellent news for you. Based on the information you provided, I was able to locate a plan for you through AWA American Workers Association which uses the Cigna Healthcare PPO network, giving you access to approximately 1.6 million healthcare providers nationwide. There's no requirement for referrals to visit a specialist. You are going to receive coverage for doctor visits, specialist visits, urgent care, diagnostic and lab work, hospital services, surgery, and emergency treatment as well. This plan requires medical underwriting and has a set deductible of $__________.\n\nIn order to determine eligibility I will read you a list of 15 conditions. Please confirm if you currently have or if you've ever been diagnosed with the following conditions:\n\nHeart Disorder, Stroke, Chron's Disease, Ulcerative Colitis, Liver or Kidney Disorder, Emphysema, COPD, Cancer or Tumor, Alcohol or Drug Abuse, HIV or AIDS, Multiple Sclerosis, Tuberculosis, Autism, Schizophrenia, Lupus, Bariatric or Weight Loss Surgery, Pregnancy? ▶ ( Wait for Answer )\n\nGreat. Based on everything we've reviewed, the monthly rate for this plan comes out to $___. There is a one-time standard (AWA) association fee of $___ to activate your membership within the plan. That brings the total for the first month to $___, and then moving forward, your monthly cost is simply $___ thereafter. Now, assuming this plan meets your medical needs, would the initial first-month amount of $___ be affordable for you today?\" ▶ ( Wait for answer )\n\nPerfect. What I'll do next is walk you through the full benefits of the program. If everything looks good to you, we'll move forward with submitting the application to the insurance company. During the verification process, you'll receive an email that includes an outline of your coverage along with digital insurance cards. Your physical cards will then arrive by mail within approximately one to three weeks. Okay? ▶ ( Wait for answer)"
      },
      {
        title: 'Benefits & Copays',
        content:
          "For your doctor's visits, you'll have access to Cigna Healthcare PPO Network and you do not need a referral to see a specialist. When you go to the doctor's office you'll have a co-pay for your visit. You have unlimited visits for your primary doctors, urgent care, and for your specialist at a $40 co-pay. You also receive an annual wellness visit with the plan, for the wellness exam, the deductible is waived and coinsurance applies. Mammograms and Colonoscopies are provided at no cost Your deductible will generally come into play in the event of hospitalization or surgery. For those services you have a $_____ deductible. After the deductible is met, you have 80/20 or 70/30 or 100/0 coinsurance with a Maximum out of Pocket of $5000 and with a cap of $1,500,000. How is this sounding so far? ✖ ( DO NOT WAIT - GO TO RX )"
      },
      {
        title: 'Prescription (RX)',
        content:
          "You'll also receive access to a prescription discount program you can use at major pharmacies. Discounts vary, but many members find it helpful. ✖ ( DO NOT WAIT GO INTO CLOSING STATEMENT )"
      },
      {
        title: 'Closing Statement',
        content:
          "Your coverage is scheduled to start on ______, pending enrollment and verification. You can see in-network providers with no referral required, and the plan includes day-to-day benefits and for more serious care, such as hospital stays or surgeries, the plan uses the deductible and coinsurance we've reviewed. Before we proceed, can you confirm that everything we've reviewed about the plan and its limitations has been explained and understood? ▶ ( Wait for Answer )\n\nOK Perfect, what is a good email we can send all this over to?\n\nWould you like your insurance cards issued with a middle initial, or just your first and last name?\n\nWhat is the physical mailing address where we should send your hard-copy documents to?\n\nGreat. And just to confirm, is this phone number ________ the best number for the insurance company to reach you if they have any follow-up or verification questions?\n\nBefore we complete the enrollment, I do need to verify a few items on this recorded line. Can you please confirm that you are a United States citizen or legal resident, and that all health information you provided today is accurate and complete to the best of your knowledge? Lastly, for identity verification purposes, please confirm your Social Security number? ▶ ( Wait for Answer )\n\nFor the initial payment, which card type would you prefer you put on file? ▶ ( Wait for Answer )\n\nOk go ahead with the card number. (OR) I'm ready for the card number when you're ready. ✖ ( DO NOT SPEAK WHOEVER TALKS FIRST LOSES )"
      },
      {
        title: 'Verification',
        content:
          "This is the final step. I'm sending you a text now from an 848 number labeled 'ONE ENROLLMENT.' Please click the link once you receive it. Let me know when you see it. ▶ ( Wait for Answer )\n\nGreat. Please open the link and, if possible, place your phone on speaker so I can walk you through the document. Your role here is simply to confirm that everything has been entered correctly. I'll have you verify the spelling of your first and last name, your home address, email address, and phone number, as well as confirm that your date of birth and gender are accurate. I'll also ask you to confirm the payment method on file and the billing address associated with the application. Once you've reviewed everything, let me know—does it all look correct?\" ▶ ( Wait for Answer)\n\nAs you scroll down, you'll see what's called a bill-by-benefit breakdown. It's just a transparent summary showing how the policy is set up and how the cost is allocated across the benefits.\n\nAt the bottom, enter your first and last name—please capitalize both. Then sign electronically with your finger. You can leave the last checkbox unchecked unless you're applying for your child only. Click 'Accept' and tell me what you see.\n\n(You've successfully signed your document)\n\nNotes: ▶ If needed: Don't forget to enroll customer GoodRX Account. ▶ You will need a verification code from the customer. Via TEXT. ▶ Remind customer to use GoodRX and not their insurance card at the pharmacy. Customer provides pharmacist of their GoodRX Account."
      },
      {
        title: 'Post Close',
        content:
          "Perfect—I've received your signature on my end. I'm going to go ahead and submit your application to the insurance carrier now. ✔ ( If it goes through )\n\nCongratulations [Customer Name], your application is complete. Do you have a pen and paper? Our customer service number is 855-736-1590, available Monday through Friday, 9:00 a.m. to 9:00 p.m. Eastern. I'll also provide you with my direct extension for future reference.\n\nYour confirmation number is CHA561337—please keep that for your records. If anyone calls claiming to be from our agency and can't provide that number, they're not affiliated with us.\n\nNow go ahead and write down Cigna Healthcare PPO Network .\n\nThe website you can visit to search providers is: hcpdirectory.cigna.com/. Make sure you choose PPO, Choice Fund PPO when searching for providers.\n\nWith today's payment, your policy will become effective on _______. Your second payment will then be due 30 days from that effective date.\n\n(If it's a postdate, make sure you state the dates correctly for the first billing date and the effective date)\n\nYou'll receive two ID cards by mail about 7 to 10 business days after your effective date. One is a discount card for prescriptions and other added benefits like dental and vision. The second card is your actual insurance ID card and will clearly show Cigna Healthcare PPO Network.\n\nJust for your records, I want to quickly recap the main details you'll see in your paperwork. Your plan uses the Cigna Healthcare PPO Network for doctors and hospitals.\n\nThe insurance benefits are underwritten by Everest Reinsurance Company, or Everest Denali Insurance Company depending on the state you live in. Everest is also the plan administrator.\n\nYour monthly billing is handled through Neo Health Solutions, which is the name you'll see on your statements. All of this will be clearly outlined in your policy documents.\n\nI do want to clarify that this is a private, short term health plan, not an ACA or major medical plan, and it does not provide coverage for maternity, substance abuse, or psychiatric services.\n\n- I also want to explain the 12 and 12 pre-existing condition clause, which states anything diagnosed in the last 12 months would have a 12-month waiting period. There is a standard 30-day waiting period for any hospital,sickness and scheduled doctor visits.\n\nIf you need to add or change dependents in the future, that can be done on the plan's annual anniversary, without having to cancel your coverage.\n\nIf you have any friends or family members that need quality coverage, please give them my information, it would be greatly appreciated. We will find them the right plan just as we did for you.\n\nAlright [Customer Name], you've been an absolute pleasure. Now do you have any questions before we disconnect?"
      }
    ]
  },
  {
    ...
    sections: [
      ...
      },
      {
        title: 'Benefits & Copays',
        content:
          "For your doctor's visits, you'll have access to Cigna Healthcare PPO Network and you do not need a referral to see a specialist. When you go to the doctor's office you'll have a co-pay for your visit. For primary doctors visits, urgent care, and for your specialist visits it's a $40 co-pay. Those visits aren't subject to the deductible. You also receive an annual wellness visit with the plan, for the wellness exam, the deductible is waived and coinsurance applies. Mammograms and Colonoscopies are provided at no cost Your deductible will generally come into play in the event of hospitalization or surgery. For those services you have a $_____ deductible. After the deductible is met, you have 80/20 or 70/30 or 100/0 coinsurance with a Maximum out of Pocket of $5000 and with a cap of $1,000,000. How is this sounding so far? ✖ ( DO NOT WAIT - GO TO RX )"
      },
      {
        title: 'Prescription (RX)',
        content:
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        title: 'Benefits & Copays',
        content:
          "For your doctor's visits, you'll have access to Cigna Healthcare PPO Network and you do not need a referral to see a specialist. When you go to the doctor's office you'll have a co-pay for your visit. For primary doctors visits, urgent care, and for your specialist visits it's a $50 co-pay. Those visits aren't subject to the deductible. You also receive an annual wellness visit with the plan, for the wellness exam, the deductible is waived and coinsurance applies. Mammograms and Colonoscopies are provided at no cost Your deductible will generally come into play in the event of hospitalization or surgery. For those services you have a $_____ deductible. After the deductible is met, you have 80/20 or 70/30 or 100/0 coinsurance with a Maximum out of Pocket of $5000 and with a cap of $750,000. How is this sounding so far? ✖ ( DO NOT WAIT - GO TO RX )"
      },
      {
        title: 'Prescription (RX)',
        content:
  ...
  {
    name: "Goodlife Partners WB Choice and WB Select (Match Doctor visits to Plan)",
    planType: 'Limited',
    sections: [
      {
        title: "Opening & Medical Underwriting",
        content:
          "✖ ( DO NOT ASK IF THEY ARE STILL THERE) Alright [Customer Name], I have some excellent news for you. Based on the information you provided, I was able to locate a plan for you through the FirstHealth PPO Network, a CVS Company. This plan offers fixed benefits for doctor visits, hospital care, and prescription savings. You have the flexibility to see any provider within the network, and there's no requirement for referrals to visit a specialist. Another key advantage is nationwide access—this coverage can be used anywhere the network is accepted. And most importantly, there is no deductible. Does everything sound clear so far? ▶ ( Wait for Answer )\n\n\"Great. Based on everything we've reviewed, the monthly rate for this plan comes out to $___. There is a one-time standard group association fee of $___ to activate your membership within the plan. That brings the total for the first month to $___, and then moving forward, your monthly cost is simply $___ thereafter. Now, assuming this plan meets your medical needs, would the initial first-month amount of $___ be affordable for you today?\" ▶ ( Wait for answer )\n\nPerfect. What I'll do next is walk you through the full benefits of the program. If everything looks good to you, we'll move forward with submitting the application to the insurance company. During the verification process, you'll receive an email that includes an outline of your coverage along with digital insurance cards. Your physical cards will then arrive by mail within approximately one to three weeks. Okay? ▶ ( Wait for answer )"
      },
      {
        title: "Benefits & Copays",
        content:
          "Let's start by reviewing how your doctor visits work so you can see how the plan functions, and then—if everything looks good—we'll move forward with submitting the application. Sounds good? ▶ ( Wait for answer )\n\nYou don't need referrals to see a specialist. When you visit a primary physician you will pay $60 (WB Choice) / $50 (WB Select). When you visit a specialist or Urgent Care you will pay $75 (Both plans the same) and you also have your preventative care benefits included as well. Do you follow me so far?▶ ( Wait for Answer )\n\nPeople like this plan because it's simple. Unlike traditional plans with deductibles and coinsurance, this plan has no deductible and pays defined benefit amounts toward covered services at ANY hospital in the country—so you know what the plan contributes and can plan your expenses more easily. ✖ ( DO NOT WAIT - GO TO RX )"
      },
      {
        title: "Prescription (RX)",
        content:
          "You'll also receive access to a prescription discount program you can use at major pharmacies. Discounts vary, but many members find it helpful. The plan does not include benefits for mental health, substance abuse, or pregnancy-related care. You won't be needing coverage for those services, correct?\" ✖ ( DO NOT WAIT GO RIGHT TO CLOSING STATEMENT )"
      },
      {
        title: "Closing Statement",
        content:
          "Your coverage is scheduled to start on ______, pending enrollment and verification. You can see in-network providers with no referral required, and the plan includes day-to-day benefits and fixed hospital benefits, all with no deductible. Before we proceed, can you confirm that everything we've reviewed about the plan and its limitations has been explained and understood? ▶ ( Wait for Answer )\n\nOK Perfect, what is a good email we can send all this over to?\n\nWould you like your insurance cards issued with a middle initial, or just your first and last name?\n\nWhat is the physical mailing address where we should send your hard-copy documents to?\n\nGreat. And just to confirm, is this phone number ________ the best number for the insurance company to reach you if they have any follow-up or verification questions?\n\nBefore we complete the enrollment, I do need to verify a few items on this recorded line. Can you please confirm that you are a United States citizen or legal resident, and that all health information you provided today is accurate and complete to the best of your knowledge? Lastly, for identity verification purposes, please confirm your Social Security number?▶ ( Wait for Answer )\n\nNow you can always change this in the future, but for the first month we can put on file a VISA, MASTERCARD, AMEX, OR DISCOVER - which do you prefer? ▶ ( Wait for Answer )\n\nOk go ahead with the card number. (OR) I'm ready for the card number when you're ready. ✖ ( DO NOT SPEAK WHOEVER TALKS FIRST LOSES )"
      },
      {
        title: "Verification",
        content:
          "This is the final step. I'm sending you a text now from a 848 number labeled 'ONE ENROLLMENT.' Please click the link once you receive it. Let me know when you see it. ▶ ( Wait for Answer )\n\nGreat. Please open the link and, if possible, place your phone on speaker so I can walk you through the document. Your role here is simply to confirm that everything has been entered correctly. I'll have you verify the spelling of your first and last name, your home address, email address, and phone number, as well as confirm that your date of birth and gender are accurate. I'll also ask you to confirm the payment method on file and the billing address associated with the application. Once you've reviewed everything, let me know—does it all look correct?\" ▶ ( Wait for Answer)\n\nAs you scroll down, you'll see what's called a bill-by-benefit breakdown. It's just a transparent summary showing how the policy is set up and how the cost is allocated across the benefits. (Everest has 1 check box asking consent for email in the middle of the verification.)\n\nAt the bottom, enter your first and last name—please capitalize both. Then sign electronically with your finger. You can leave the last checkbox unchecked unless you're applying for your child only. Click 'Accept' and tell me what you see.\n\n(You've successfully signed your document)\n\nNotes: ▶ If needed: Don't forget to enroll customer GoodRX Account. ▶ You will need a verification code from the customer. Via TEXT.\n\n▶ Remind customer to use GoodRX and not their insurance card at the pharmacy. Customer provides pharmacist of their GoodRX Account."
      },
      {
        title: "Post Close",
        content:
          "Perfect—I've received your signature on my end. I'm going to go ahead and submit your application to the insurance carrier now. ✔ ( If it goes through )\n\nCongratulations [Customer Name], your application is complete. Do you have a pen and paper? Our customer service number is 855-736-1590, available Monday through Friday, 9:00 a.m. to 9:00 p.m. Eastern. I'll also provide you with my direct extension for future reference.\n\nYour confirmation number is CHA561337—please keep that for your records. If anyone calls claiming to be from our agency and can't provide that number, they're not affiliated with us.\n\nNow go ahead and write down FIRST HEALTH NETWORK.\n\nThe website you can visit to search providers is:\n\nproviderlocator.firsthealth.com\n\nWith today's payment, your policy will become effective on _______. Your second payment will then be due 30 days from that effective date.\n\n(If it's a postdate, make sure you state the dates correctly for the first billing date and the effective date)\n\nYou'll receive two ID cards by mail about 7 to 10 business days after your effective date. One is a discount card for prescriptions and other added benefits like dental and vision. The second card is your actual insurance ID card and will clearly show FIRST HEALTH PPO NETWORK.\n\nJust for your records, I want to quickly recap the main details you'll see in your paperwork. Your plan uses the FirstHealth PPO Network for doctors and hospitals.\n\nThe Plan Administrator / Claims Administrator: Merchants Benefit Administration (MBA)\n\nYour monthly billing is handled through NEO Insurance Solutions, which is the name you'll see on your statements. All of this will be clearly outlined in your policy documents.\n\nI do want to clarify that this is a private, limited-benefit plan, not an ACA or major medical plan, and it does not provide coverage for maternity, substance abuse, or psychiatric services.\n\n- I also want to explain the 12 and 12 pre-existing condition clause, which states anything diagnosed in the last 12 months would have a 12-month waiting period for hospital stays or surgeries. There is a standard 30-day waiting period for any sickness.\n\nIf you have any friends or family members that need quality coverage, please give them my information, it would be greatly appreciated. We will find them the right plan just as we did for you.\n\nAlright [Customer Name], you've been an absolute pleasure. Now do you have any questions before we disconnect?"
      }
    ]
  }
];
  ...
  for (var gi = 0; gi < stages.length; gi++) {
    ...
    if (gi > 0) {
      html +=
        ...
        (gi - 1) +
        ')" style="padding:10px 24px;border-radius:10px;border:1px solid var(--border-light, var(--border-default));background:var(--cha-bg-card);font-size:14px;cursor:pointer;">← Previous</button>';
    } else {
      html += '<span></span>';
    }
...
function renderPlanScripts() {
  ...
  if (planScriptActive < 0 || planScriptActive >= filtered.length) {
    ...
    filtered.forEach(function (p, idx) {
      ...
      html +=
        ...
        idx +
        ";planScriptSection=0;renderPlanScripts()\" style=\"background:var(--cha-bg-card);border:1px solid var(--border-light, var(--border-default));border-radius:16px;padding:16px 18px;cursor:pointer;transition:all 0.15s ease;min-height:90px;display:flex;flex-direction:column;justify-content:space-between;\" onmouseover=\"this.style.borderColor='#5175f1';this.style.boxShadow='0 0 0 2px rgba(81,117,241,0.15)';this.style.transform='translateY(-1px)'\" onmouseout=\"this.style.borderColor='var(--cha-border-default)';this.style.boxShadow='none';this.style.transform='none'\">";
      html +=
      ...
      p.sections.forEach(function (s, si) {
        ...
        html +=
          '<span style="font-size:9px;padding:2px 6px;border-radius:999px;background:var(--cha-bg-muted);color:var(--text-secondary);">' +
          pl +
          '</span>';
      });
      html += '</div></div>';
  ...
  var _complianceBannerType = (function(n) {
    ...
    var MEC = ['TrueHealth / MedFirst / GoodHealth 1,2,3', 'MedFirst / GoodHealth 4,5', 'NEO Smart Choice'];
    var STM = ['Access Health STM', 'NEO Pinnacle STM Traditional', 'AFRP Galena STM Elite', 'AFRP Galena STM Standard', 'AFRP Galena STM Economy', 'Smart Health STM Traditional', 'Smart Health STM Limited', 'Harbor STM Secure', 'Harbor STM Access', 'Harbor STM Essential'];
    var LTD = ['Everest / HarmonyCare / SigmaCare', 'BWA Paramount 1-6', 'BWA Americare 2,3,4', 'Health Choice Silver', 'Pinnacle Protect Plan 1-4', 'Goodlife Partners WB Choice and WB Select (Match Doctor visits to Plan)'];
