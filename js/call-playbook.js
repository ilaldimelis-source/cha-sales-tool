...
function renderPlanScripts() {
  ...
  activePlan.sections.forEach(function (sec, si) {
    ...
    html +=
      ...
      (isCurrent ? '#5B8DEF' : si < planScriptSection ? '#BBF7D0' : 'var(--cha-bg-muted)') +
      ';border:2px solid ' +
      (isCurrent ? '#5B8DEF' : si < planScriptSection ? '#15803D' : 'var(--cha-border-default)') +
      ';"></div>';
    html +=
