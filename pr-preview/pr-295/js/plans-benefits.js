...
const PLANS = [
...

  {
    ...
    type: 'Short-Term Medical',
    tagline: 'Cigna PPO short-term medical through AWA. Not MEC. Not ACA.',
    ...
    bestFor: 'Short-term medical on the Cigna PPO network',
    notGood: 'Needs MEC or ACA coverage, or out-of-network office visits',
    idealClient: 'Someone who can use Cigna PPO providers',
    topPoints: [
      'Deductible options: 2500 / 5000 / 7500 / 10000',
      'Member coinsurance: 30%, 20% or 0%',
  ...
  showGroups.forEach(function (grp) {
    ...
    docs.forEach(function (doc) {
      ...
      var networkPill = doc.network
        ? '<span style="font-size:9px;padding:2px 7px;border-radius:999px;background:#f1f3f9;color:#64748b;font-weight:500;border:1px solid #e2e8f0;">' +
          escHTML(doc.network) +
          '</span>'
        : '';
...
function renderNetworkexplainer() {
  var networks = [
    ...
    {
      name: 'Cigna Healthcare PPO for Shared Administration',
      color: 'var(--cha-accent)',
      bg: 'var(--cha-bg-muted)',
      plans: ['Harbor STM Essential', 'Harbor STM Access', 'Harbor STM Secure'],
      website: 'hcpdirectory.cigna.com/web/public/consumer/directory/search',
      warning:
